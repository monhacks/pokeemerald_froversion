...
BattleScript_HandleFaintedMon::
	...
	jumpifbattletype BATTLE_TYPE_TRAINER | BATTLE_TYPE_DOUBLE | BATTLE_TYPE_REGI, BattleScript_FaintedMonTryChooseAnother
...
BattleScript_LocalBattleLost::
	...
	@ FLAG_CAN_LOSE_NEXT_BATTLE
	jumpifbyte CMP_COMMON_BITS, gSpecialFlags, 0x20, BattleScript_LocalBattleLostEnd_
...
BattleScript_DarknessContinues::
	printstring STRINGID_ITISDARK
	waitmessage 0x40
	playanimation BS_ATTACKER, B_ANIM_DARKNESS_CONTINUES, NULL
	end2

BattleScript_DarknessReturns::
	printstring STRINGID_DARKNESSRETURNED
	waitmessage 0x40
	playanimation BS_ATTACKER, B_ANIM_DARKNESS_CONTINUES, NULL
	end2

BattleScript_FlashDarkness::
...
BattleScript_OverworldWeatherStarts1::
	printfromtable gWeatherStartsStringIds
	waitmessage 0x40
	playanimation2 BS_ATTACKER, sB_ANIM_ARG1, NULL
	end3
