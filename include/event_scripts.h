...
extern const u8 EscapeRoom_Debug[];
...
extern const u8 EventScript_IsWesternApproachTrap[];
...
extern const u8 EventScript_CharacterSwitch[];
extern const u8 EventScript_Timeout[];
