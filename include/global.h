...
struct SaveBlock2
{
    /*0x00*/ u8 playerName[PLAYER_NAME_LENGTH + 1];
                ...
                u8 playerName3[PLAYER_NAME_LENGTH + 1];
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsWindowAutoRun:1; // AUTORUN[ENABLED/DISABLED]
             u16 optionsWindowDifficulty:3; // OPTIONS_DIFFICULTY[EASY/NORMAL/HARD]
             u16 optionsWindowWildEncounters:1; // OPTIONS_WILD_ENCOUNTERS[ON/OFF]
...
struct Bag
{
    struct ItemSlot pocket_Items[BAG_ITEMS_COUNT];
    struct ItemSlot pocket_KeyItems[BAG_KEYITEMS_COUNT];
    struct ItemSlot pocket_PokeBalls[BAG_POKEBALLS_COUNT];
    struct ItemSlot pocket_TMHM[BAG_TMHM_COUNT];
    struct ItemSlot pocket_Berries[BAG_BERRIES_COUNT];
};
...
#define B_VERSION_ESCAPE_ROOM_SNOW   FALSE
#define B_VERSION_ESCAPE_ROOM_PLAINS_GRASS FALSE
#define B_VERSION_ESCAPE_ROOM_MOUNTAIN TRUE
