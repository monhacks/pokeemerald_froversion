...
extern const u16 *const gBerryTreeObjectEventGraphicsIdTablePointers[]; //added for dynamic OW
extern const struct SpriteFrameImage *const gBerryTreePicTablePointers[]; 
extern const u16 *const gBerryTreePaletteSlotTablePointers[]; //added for dynamic OW
...
void LoadObjectEventPalette(u16 paletteTag); // added for dynamic OW
