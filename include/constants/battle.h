...
#define STATUS_FIELD_DARK_TETHER        0x1000
#define STATUS_FIELD_DRAGON_RAVINE      0x2000

#define STATUS_TERRAIN_ANY              (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_DARK_TETHER | STATUS_FIELD_DRAGON_RAVINE)
...
#define WEATHER_DREAM_FOG_PERMANENT (1 << 9)
#define WEATHER_DREAM_FOG_ANY       (WEATHER_DREAM_FOG_PERMANENT)
#define WEATHER_DARKNESS_PERMANENT  (1 << 10)
#define WEATHER_DARKNESS_ANY        (WEATHER_DARKNESS_PERMANENT)
#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_DREAM_FOG_ANY | WEATHER_DARKNESS_ANY)
