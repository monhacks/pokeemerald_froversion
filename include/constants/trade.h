...
// In-game Trade IDs
#define INGAME_TRADE_MEDITITE 0
#define INGAME_TRADE_CONTRARAM 1
#define INGAME_TRADE_SNOUMESE 2
#define INGAME_TRADE_CHANSEY 3
#define INGAME_TRADE_BILLFALO 4
