...
extern const u8 BattleScript_DreamFogYawn[];
extern const u8 BattleScript_DreamFogEffect[];
extern const u8 BattleScript_DarknessContinues[];
extern const u8 BattleScript_DarknessReturns[];
extern const u8 BattleScript_FlashDarkness[];
extern const u8 BattleScript_OverworldWeatherStarts[];
extern const u8 BattleScript_OverworldWeatherStarts1[];
extern const u8 BattleScript_PoisonFieldStarts[];
...
extern const u8 BattleScript_DmgLandmineOnAttacker[];
extern const u8 BattleScript_DmgLandmineOnTarget[];
extern const u8 BattleScript_DmgLandmineOnFaintedBattler[];
...
extern const u8 BattleScript_PoisonTurnHeal[];
...
extern const u8 BattleScript_MotorCloakActivates[];
extern const u8 BattleScript_MalevolentActivates[];
...
extern const u8 BattleScript_CharismaActivatesEnd3[];
extern const u8 BattleScript_IntimidateActivates[];
extern const u8 BattleScript_CharismaActivates[];
...
extern const u8 BattleScript_TorridActivates[];
...
extern const u8 BattleScript_AbyssalSkinActivates[];
...
extern const u8 BattleScript_SleepyHeadActivates[];
...
extern const u8 BattleScript_EffectPsychoShiftCanWorkAbility[];
...
extern const u8 BattleScript_DragonOrbActivates[];
extern const u8 BattleScript_HitAllTargetsActivates[];
...
extern const u8 BattleScript_DarkTetherActivates[];
extern const u8 BattleScript_DarkTetherEnds[];
...
extern const u8 BattleScript_DragonRavineReviveAttacker[];
extern const u8 BattleScript_DragonRavineReviveTarget[];
...
extern const u8 BattleScript_AkuBerryBoostSE[];
extern const u8 BattleScript_NikitaElectricBoost[];
extern const u8 BattleScript_NikitaFightingBoost[];
extern const u8 BattleScript_NikitaGroundBoost[];
...
extern const u8 BattleScript_DreamOrb[];
extern const u8 BattleScript_FrostOrb[];
extern const u8 BattleScript_DragonsOrbOnHitBurn[];
extern const u8 BattleScript_DragonsOrbOnHitParalyze[];
extern const u8 BattleScript_DragonsOrbOnHitFreeze[];
...
extern const u8 BattleScript_TypeWeatherActivates2_DreamFog[];
