...
extern const u32 gMonFrontPic_Buccanile[];
extern const u32 gMonFrontPic_Buccanite[];
extern const u32 gMonFrontPic_Buccafear[];
extern const u32 gMonFrontPic_Kopirar[];
extern const u32 gMonFrontPic_Kopispar[];
extern const u32 gMonFrontPic_Kopiroar[];
extern const u32 gMonFrontPic_Wallite[];
extern const u32 gMonFrontPic_Wallock[];
extern const u32 gMonFrontPic_Warsock[];
extern const u32 gMonFrontPic_Kicwindo[];
extern const u32 gMonFrontPic_Hausodoom[];
extern const u32 gMonFrontPic_Dropyce[];
extern const u32 gMonFrontPic_Metaroura[];
extern const u32 gMonFrontPic_Chernabog[];
extern const u32 gMonFrontPic_Carlile[];
...
extern const u32 gMonPalette_Buccanile[];
extern const u32 gMonPalette_Buccanite[];
extern const u32 gMonPalette_Buccafear[];
extern const u32 gMonPalette_Kopirar[];
extern const u32 gMonPalette_Kopispar[];
extern const u32 gMonPalette_Kopiroar[];
extern const u32 gMonPalette_Wallite[];
extern const u32 gMonPalette_Wallock[];
extern const u32 gMonPalette_Warsock[];
extern const u32 gMonPalette_Kicwindo[];
extern const u32 gMonPalette_Hausodoom[];
extern const u32 gMonPalette_Dropyce[];
extern const u32 gMonPalette_Metaroura[];
extern const u32 gMonPalette_Chernabog[];
extern const u32 gMonPalette_Carlile[];
...
extern const u32 gMonBackPic_Buccanile[];
extern const u32 gMonBackPic_Buccanite[];
extern const u32 gMonBackPic_Buccafear[];
extern const u32 gMonBackPic_Kopirar[];
extern const u32 gMonBackPic_Kopispar[];
extern const u32 gMonBackPic_Kopiroar[];
extern const u32 gMonBackPic_Wallite[];
extern const u32 gMonBackPic_Wallock[];
extern const u32 gMonBackPic_Warsock[];
extern const u32 gMonBackPic_Kicwindo[];
extern const u32 gMonBackPic_Hausodoom[];
extern const u32 gMonBackPic_Dropyce[];
extern const u32 gMonBackPic_Metaroura[];
extern const u32 gMonBackPic_Chernabog[];
extern const u32 gMonBackPic_Carlile[];
...
extern const u32 gMonShinyPalette_Buccanile[];
extern const u32 gMonShinyPalette_Buccanite[];
extern const u32 gMonShinyPalette_Buccafear[];
extern const u32 gMonShinyPalette_Kopirar[];
extern const u32 gMonShinyPalette_Kopispar[];
extern const u32 gMonShinyPalette_Kopiroar[];
extern const u32 gMonShinyPalette_Wallite[];
extern const u32 gMonShinyPalette_Wallock[];
extern const u32 gMonShinyPalette_Warsock[];
extern const u32 gMonShinyPalette_Kicwindo[];
extern const u32 gMonShinyPalette_Hausodoom[];
extern const u32 gMonShinyPalette_Dropyce[];
extern const u32 gMonShinyPalette_Metaroura[];
extern const u32 gMonShinyPalette_Chernabog[];
extern const u32 gMonShinyPalette_Carlile[];
...
extern const u32 gMonStillFrontPic_Buccanile[];
extern const u32 gMonStillFrontPic_Buccanite[];
extern const u32 gMonStillFrontPic_Buccafear[];
extern const u32 gMonStillFrontPic_Kopirar[];
extern const u32 gMonStillFrontPic_Kopispar[];
extern const u32 gMonStillFrontPic_Kopiroar[];
extern const u32 gMonStillFrontPic_Wallite[];
extern const u32 gMonStillFrontPic_Wallock[];
extern const u32 gMonStillFrontPic_Warsock[];
extern const u32 gMonStillFrontPic_Kicwindo[];
extern const u32 gMonStillFrontPic_Hausodoom[];
extern const u32 gMonStillFrontPic_Dropyce[];
extern const u32 gMonStillFrontPic_Metaroura[];
extern const u32 gMonStillFrontPic_Chernabog[];
extern const u32 gMonStillFrontPic_Carlile[];
...
extern const u8 gMonFootprint_Buccanile[];
extern const u8 gMonFootprint_Buccanite[];
extern const u8 gMonFootprint_Buccafear[];
extern const u8 gMonFootprint_Kopirar[];
extern const u8 gMonFootprint_Kopispar[];
extern const u8 gMonFootprint_Kopiroar[];
extern const u8 gMonFootprint_Wallite[];
extern const u8 gMonFootprint_Wallock[];
extern const u8 gMonFootprint_Warsock[];
extern const u8 gMonFootprint_Kicwindo[];
extern const u8 gMonFootprint_Hausodoom[];
extern const u8 gMonFootprint_Dropyce[];
extern const u8 gMonFootprint_Metaroura[];
extern const u8 gMonFootprint_Chernabog[];
extern const u8 gMonFootprint_Carlile[];
...
extern const u8 gMonIcon_Buccanile[];
extern const u8 gMonIcon_Buccanite[];
extern const u8 gMonIcon_Buccafear[];
extern const u8 gMonIcon_Kopirar[];
extern const u8 gMonIcon_Kopispar[];
extern const u8 gMonIcon_Kopiroar[];
extern const u8 gMonIcon_Wallite[];
extern const u8 gMonIcon_Wallock[];
extern const u8 gMonIcon_Warsock[];
extern const u8 gMonIcon_Kicwindo[];
extern const u8 gMonIcon_Hausodoom[];
extern const u8 gMonIcon_Dropyce[];
extern const u8 gMonIcon_Metaroura[];
extern const u8 gMonIcon_Chernabog[];
extern const u8 gMonIcon_Carlile[];
