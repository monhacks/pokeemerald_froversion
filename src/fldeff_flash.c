...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_TOWN,        MAP_TYPE_VOLCANO,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_CITY,        MAP_TYPE_VOLCANO,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_ROUTE,       MAP_TYPE_VOLCANO,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_UNDERWATER,  MAP_TYPE_VOLCANO,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_OCEAN_ROUTE, MAP_TYPE_VOLCANO,  TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_VOLCANO, MAP_TYPE_UNDERWATER,  FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_VOLCANO, MAP_TYPE_OCEAN_ROUTE, FALSE,  TRUE, DoExitCaveTransition},
