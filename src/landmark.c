...
static const u8 LandmarkName_PetalburgWoods[] = _("Jagow Woods");
static const u8 LandmarkName_MrBrineysCottage[] = _("K. Trippy's Cottage");
static const u8 LandmarkName_AbandonedShip[] = _("Abandoned Ship");
static const u8 LandmarkName_SeashoreHouse[] = _("Seashore House");
static const u8 LandmarkName_SlateportBeach[] = _("Riverside Beach");
static const u8 LandmarkName_CyclingRoad[] = _("Lasalle Expr");
static const u8 LandmarkName_NewMauville[] = _("New Wheatfield");
...
static const u8 LandmarkName_RusturfTunnel[] = _("Diglett Tunnel");
