const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_RASCALOOT] = _("Rascaloot"),
    [SPECIES_BANDITHUG] = _("Bandithug"),
    [SPECIES_RUTHLASH] = _("Ruthlash"),
    [SPECIES_FLOBRA] = _("Flobra"),
    [SPECIES_MORPHLO] = _("Morphlo"),
    [SPECIES_MECHOBRA] = _("Mechobra"),
    [SPECIES_EMBORYPS] = _("Emboryps"),
    [SPECIES_HUNTORYPS] = _("Huntoryps"),
    [SPECIES_RIPTORYPS] = _("Riptoryps"),
    [SPECIES_SPIRITOMB] = _("Spiritomb"),
    [SPECIES_SNOUMESE] = _("Snoumese"),
    [SPECIES_SNOUBAUL] = _("Snoubaul"),
    [SPECIES_NEVAWOK] = _("Nevawok"),
    [SPECIES_WOKAGIN] = _("Wokagin"),
    [SPECIES_VAYPING] = _("Vayping"),
    [SPECIES_KABOWL] = _("Kabowl"),
    [SPECIES_BOWLAST] = _("Bowlast"),
    [SPECIES_PHOKAI] = _("Phokai"),
    [SPECIES_PHOTASM] = _("Photasm"),
    [SPECIES_PHOTOGEIST] = _("Photogeist"),
    [SPECIES_TOGEKISS] = _("Togekiss"),
    [SPECIES_OTDORBLE] = _("Otdorble"),
    [SPECIES_LUTRADOR] = _("Lutrador"),
    [SPECIES_DUMBELLION] = _("Dumbellion"),
    [SPECIES_BARBELLION] = _("Barbellion"),
    [SPECIES_OCTIRE] = _("Octire"),
    [SPECIES_INVERTEBRAKE] = _("Vertebrake"),
    [SPECIES_HAAGLET] = _("Haaglet"),
    [SPECIES_WARTHAAG] = _("Warthaag"),
    [SPECIES_TAQUITTLE] = _("Taquittle"),
    [SPECIES_ESCARATACO] = _("Escarataco"),
    [SPECIES_CHAD_BUG_1] = _("Klendart"),
    [SPECIES_CHAD_BUG_2] = _("Mosklendo"),
    [SPECIES_PILOPOO] = _("Pilopoo"),
    [SPECIES_BILLFALO] = _("Billfalo"),
    [SPECIES_SABLIZZARD] = _("Sablizzard"),
    [SPECIES_PASSIMIAN] = _("Passimian"),
    [SPECIES_CACTAR] = _("Cactar"),
    [SPECIES_CRACTHORN] = _("Cracthorn"),
    [SPECIES_CRACKTUSS] = _("Cracktuss"),
    [SPECIES_DRACASTER] = _("Dracaster"),
    [SPECIES_BLUE_EYES] = _("Wheyevrn"),
    [SPECIES_REDEYES] = _("Voeyedra"),
    [SPECIES_MAROWAK_ALOLAN] = _("Filler2"),
    [SPECIES_CONTRARAM] = _("Contraram"),
    [SPECIES_PLASMUNG] = _("Plasmung"),
    [SPECIES_GRUNTAZE] = _("Gruntaze"),
    [SPECIES_ELITETRIC] = _("Elitetric"),
    [SPECIES_MEGA_DEWGONG] = _("Mike Seel"),
    [SPECIES_FILLER_8] = _("Houndoom"),
    [SPECIES_FILLER_9] = _("Gengar"),
    [SPECIES_FRENTOAD] = _("Frentoad"),
    [SPECIES_RABATOAST] = _("Rabatoast"),
    [SPECIES_SHADOW_CHARIZARD] = _("Charizard"),
    [SPECIES_ABYSSALDRAGONTHIRDEVO] = _("Dragon3"),
    [SPECIES_ABYSSALDRAGONSECONDEVO] = _("Dragon2"),
    [SPECIES_ABYSSALDRAGONFIRSTEVO] = _("Dragon1"),
    [SPECIES_CHEETO] = _("Filler16"),
    [SPECIES_FILLER_17] = _("Filler17"),
    [SPECIES_FILLER_18] = _("Filler18"),
    [SPECIES_FILLER_19] = _("Filler19"),
    [SPECIES_FILLER_20] = _("Filler20"),
    [SPECIES_FILLER_21] = _("Filler21"),
    [SPECIES_FILLER_22] = _("Filler22"),
    [SPECIES_FILLER_23] = _("Filler23"),
    [SPECIES_FILLER_24] = _("Filler24"),
    [SPECIES_FILLER_25] = _("Filler25"),
    [SPECIES_FILLER_26] = _("Filler26"),
    [SPECIES_FILLER_27] = _("Filler27"),
    [SPECIES_FILLER_28] = _("Filler28"),
    [SPECIES_FILLER_29] = _("Filler29"),
    [SPECIES_FILLER_30] = _("Filler30"),
    [SPECIES_FILLER_31] = _("Filler31"),
    [SPECIES_FILLER_32] = _("Filler32"),
    [SPECIES_FILLER_33] = _("Filler33"),
    [SPECIES_FILLER_34] = _("Filler34"),
    [SPECIES_FILLER_35] = _("Filler35"),
    [SPECIES_FILLER_36] = _("Filler36"),
    [SPECIES_ARIADOS_GHOST] = _("Ariados"),
    [SPECIES_FILLER_38] = _("Filler38"),
    [SPECIES_CHARIZARD_X] = _("Charizard"),
    [SPECIES_WARKLOCK] = _("Warklock"),
    [SPECIES_CLOCLOCK] = _("Cloclock"),
    [SPECIES_SPIRETT] = _("Spirett"),
    [SPECIES_METAGROSS_FIRE] = _("Metagross"),
    [SPECIES_METAGROSS_WATER] = _("Metagross"),
    [SPECIES_METAGROSS_GRASS] = _("Metagross"),
    [SPECIES_METAGROSS_ELECTRIC] = _("Metagross"),
    [SPECIES_METAGROSS_NORMAL] = _("Metagross"),
    [SPECIES_METAGROSS_ICE] = _("Metagross"),
    [SPECIES_METAGROSS_FIGHTING] = _("Metagross"),
    [SPECIES_METAGROSS_POISON] = _("Metagross"),
    [SPECIES_METAGROSS_GROUND] = _("Metagross"),
    [SPECIES_METAGROSS_FLYING] = _("Metagross"),
    [SPECIES_METAGROSS_BUG] = _("Metagross"),
    [SPECIES_METAGROSS_GHOST] = _("Metagross"),
    [SPECIES_METAGROSS_DRAGON] = _("Metagross"),
