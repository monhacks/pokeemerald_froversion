//.evs = {hpEv, atkEv, defEv, speedEv, spAtkEv, spDefEv},
...
static const struct TrainerMonNoItemDefaultMoves sParty_HaighPetalburgWoods[] = {
    {
    .iv = 0,
    .lvl = 10,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout1[] = {
    {
    .iv = 150,
    .lvl = 30,
    .species = SPECIES_GOLBAT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout2[] = {
    {
    .iv = 150,
    .lvl = 28,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout3[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_GRIMER,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout4[] = {
    {
    .iv = 0,
    .lvl = 30,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout5[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_OCTIRE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout6[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_GOLBAT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMAGAHideout7[] = {
    {
    .iv = 0,
    .lvl = 30,
...
static const struct TrainerMonItemCustomMoves sParty_Matt[] = {
    ...
    .moves = {MOVE_CURSE, MOVE_BODY_SLAM, MOVE_REST, MOVE_THUNDER_PUNCH}
    },
    {
    .abilityNum = 3,
    .iv = 255,
    ...
    .moves = {MOVE_STONE_EDGE, MOVE_IRON_HEAD, MOVE_TAKE_DOWN, MOVE_ROCK_POLISH},
    },
    {
    .abilityNum = 3,
    .iv = 255,
    ...
    .moves = {MOVE_PLASMA_BLADE, MOVE_THUNDER_WAVE, MOVE_PSYSTRIKE, MOVE_EXPLOSION}
    },
    {
    .abilityNum = 3,
    .iv = 255,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STUN_SPORE, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_ACROBATICS},
    .evs = {126, 0, 126, 0, 0, 4},
    }
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_SELF_DESTRUCT, MOVE_SANDSTORM, MOVE_ANCIENT_POWER}
    },
    {
    .abilityNum = 2,
    .iv = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Dusty5[] = {
    ...
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CURSE, MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_SLEEP_TALK}
    },
    {
    .iv = 250,
    .lvl = 55,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FORCE_PALM, MOVE_KNOCK_OFF, MOVE_WHIRLWIND, MOVE_SLEEP_TALK}
    },
    {
    .abilityNum = 3,
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_SNOUBAUL,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 35,
    .species = SPECIES_FURRET,
    .moves = {MOVE_ASTONISH, MOVE_STOMP, MOVE_SWORDS_DANCE, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lola2[] = {
    ...
    .moves = {MOVE_SPIKES, MOVE_TAUNT, MOVE_EXPLOSION, MOVE_ICE_SHARD},
    .abilityNum = 3
    },
    {
    .iv = 125,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_MORNING_SUN, MOVE_EXTREME_SPEED, MOVE_TOXIC},
    .abilityNum = 2
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Lola3[] = {
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FIRE_BLAST, MOVE_DARK_PULSE, MOVE_PURSUIT, MOVE_NASTY_PLOT},
    .abilityNum = 3
    },
    {
    .iv = 125,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_MORNING_SUN, MOVE_ENCORE, MOVE_TAUNT},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Lola4[] = {
    ...
    .moves = {MOVE_ROCK_SMASH, MOVE_BRICK_BREAK, MOVE_AQUA_TAIL, MOVE_PROTECT},
    .evs = {126, 0, 4, 0, 0, 126}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lola5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_CURSE, MOVE_BATON_PASS, MOVE_MOONLIGHT}
    },
    {
    .abilityNum = 3,
    .iv = 250,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AIR_SLASH, MOVE_NASTY_PLOT, MOVE_ROOST, MOVE_DARK_PULSE}
    },
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 55,
    .species = SPECIES_WOKAGIN,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_Vito[] = {
    ...
    .iv = 75,
    .lvl = 55,
    .species = SPECIES_CHAD_BUG_2,
    .heldItem = ITEM_POISON_CAMOUFLAGE,
    .moves = {MOVE_VENOM_DRENCH, MOVE_PROTECT, MOVE_FELL_STINGER, MOVE_U_TURN},
    .abilityNum = 2
    },
    {
    .iv = 250,
    ...
    .moves = {MOVE_CURSE, MOVE_POISON_JAB, MOVE_BRICK_BREAK, MOVE_EXPLOSION},
    .abilityNum = 3
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .species = SPECIES_TEDDIURSA,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_SLASH, MOVE_PLAY_NICE, MOVE_CHARM, MOVE_BODY_SLAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_JYNX,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_ICE_BEAM, MOVE_WATER_PULSE}
    },
    {
    .iv = 100,
    .lvl = 50,
    .species = SPECIES_SABLIZZARD,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_TAKE_DOWN, MOVE_ICICLE_CRASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .lvl = 52,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_NASTY_PLOT, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_MAGIC_MIRROR}
    },
    {
    .iv = 100,
    .lvl = 53,
    .species = SPECIES_SABLIZZARD,
    .moves = {MOVE_TAUNT, MOVE_ICE_SHARD, MOVE_BODY_SLAM, MOVE_WORK_UP}
    },
    {
    .iv = 100,
    .lvl = 53,
    .species = SPECIES_JYNX,
    .moves = {MOVE_MAGIC_MIRROR, MOVE_ICE_BEAM, MOVE_LOVELY_KISS, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Takao[] = { //Messenger
    {
    .iv = 127,
    .lvl = 38,
    .species = SPECIES_PHOTOGEIST,
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROCK_POLISH, MOVE_ROLLOUT, MOVE_SMACK_DOWN}
    },
     {
    .iv = 100,
    .lvl = 24,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_ROLLOUT, MOVE_SMACK_DOWN, MOVE_ROCK_POLISH, MOVE_SELF_DESTRUCT}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Dalton2[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_PSYCHIC_TERRAIN},
    .evs = {4, 0, 0, 252, 252, 0},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_JYNX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NASTY_PLOT, MOVE_ICE_BEAM, MOVE_PSYSHOCK, MOVE_LOVELY_KISS},
    .evs = {4, 0, 0, 252, 252, 0},
    },
    {
    .abilityNum = 3,
    ...
    .moves = {MOVE_FLASH_CANNON, MOVE_PSYCHIC, MOVE_DARK_PULSE, MOVE_TRICK},
    .evs = {4, 0, 0, 252, 252, 0},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_MOONLIGHT, MOVE_ANCIENT_POWER, MOVE_FLASH},
    .evs = {252, 0, 0, 0, 4, 252},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Bernie2[] = { //PAM REMTACH
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 75,
    .species = SPECIES_FURRET,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_ROCK_SMASH, MOVE_U_TURN, MOVE_TRICK},
    .evs = {4, 252, 0, 252, 0, 0},
    },
    {
    .abilityNum = 1,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_FIRE_BLAST},
    .evs = {4, 252, 0, 252, 0, 0},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_CLEFABLE,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_CALM_MIND, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SOFT_BOILED},
    .evs = {252, 0, 0, 0, 0, 252},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_PIDGEOT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HURRICANE, MOVE_ROOST, MOVE_THUNDER, MOVE_U_TURN},
    .evs = {44, 116, 0, 116, 116, 0},
    }
};


static const struct TrainerMonItemCustomMoves sParty_Bernie3[] = { //PAM REMTACH
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 80,
...
static const struct TrainerMonItemCustomMoves sParty_Bernie4[] = { //PAM REMTACH
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 85,
...
static const struct TrainerMonItemCustomMoves sParty_Ethan2[] = { //DWIGHT
    {
    .abilityNum = 1,
    .iv = 250,
    .lvl = 77,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FLY, MOVE_SUCKER_PUNCH, MOVE_HEAT_WAVE, MOVE_PSYCHIC},
    .evs = {0, 252, 0, 252, 4, 0},
    },
    {
    .abilityNum = 2,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_PURSUIT, MOVE_ROCK_SMASH, MOVE_PUNISHMENT, MOVE_CRUSH_CLAW},
    .evs = {0, 252, 0, 252, 0, 4},
    },
    {
    .abilityNum = 3,
    ...
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FOUL_PLAY, MOVE_RECOVER, MOVE_TAUNT, MOVE_FAKE_OUT},
    .evs = {252, 0, 252, 0, 0, 8},
    },
    {
    .abilityNum = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Ethan3[] = { //DWIGHT
    {
    .abilityNum = 1,
    .iv = 250,
    .lvl = 82,
...
static const struct TrainerMonItemCustomMoves sParty_Ethan4[] = { //DWIGHT
    {
    .abilityNum = 1,
    .iv = 250,
    .lvl = 88,
...
static const struct TrainerMonItemCustomMoves sParty_Jeffrey2[] = { //jim
    {
    .abilityNum =2,
    .iv = 250,
    .lvl = 78,
    ...
    .species = SPECIES_POLIWRATH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_PUNCH, MOVE_POWER_UP_PUNCH, MOVE_ROCK_SMASH, MOVE_BELLY_DRUM},
    .evs = {252, 4, 252, 0, 0, 0},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_HEAVY_SLAM, MOVE_STONE_EDGE},
    .evs = {4, 252, 0, 252, 0, 0},
    },
    {
    .abilityNum = 2,
    ...
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_PSYCHO_CUT, MOVE_THUNDER_PUNCH, MOVE_TRICK},
    .evs = {212, 252, 0, 44, 0, 0},
    },
    {
    .abilityNum = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Jeffrey3[] = { //jim
    {
    .abilityNum =2,
    .iv = 250,
    .lvl = 83,
...
static const struct TrainerMonItemCustomMoves sParty_Jeffrey4[] = { //jim
    {
    .abilityNum =2,
    .iv = 250,
    .lvl = 88,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = { //PAM
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = { //DWIGHT
    {
    .abilityNum = 1,
    .iv = 250,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = { //jim
    {
    .abilityNum =2,
    .iv = 250,
    .lvl = 59,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_SIGNAL_BEAM},
    .evs = {4, 0, 0, 252, 252, 0},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_GRASS_KNOT},
    .evs = {4, 0, 0, 252, 252, 0},
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_STRING_SHOT, MOVE_TWINEEDLE, MOVE_FOCUS_ENERGY, MOVE_NONE},
    .abilityNum = 1
    },
    {
    .iv = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .moves = {MOVE_ICY_WIND, MOVE_BITE, MOVE_LEER, MOVE_NONE},
    .abilityNum = 1
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_FACADE, MOVE_ROCK_SLIDE, MOVE_DYNAMIC_PUNCH}
    },
    {
    .abilityNum = 1,
    .iv = 200,
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CHIP_AWAY, MOVE_BULLDOZE, MOVE_SLACK_OFF, MOVE_FIRE_PUNCH}
    },
    {
    .abilityNum = 2,
    .iv = 200,
    ...
    .species = SPECIES_RATICATE,
    .heldItem = ITEM_FLAME_ORB,
    .moves = {MOVE_FACADE, MOVE_SUCKER_PUNCH, MOVE_U_TURN, MOVE_NONE}
    },
    {
    .abilityNum = 2,
    .iv = 250,
    ...
    .species = SPECIES_PIDGEOTTO,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_WHIRLWIND, MOVE_WING_ATTACK, MOVE_RETURN}
    },
    {
    .iv = 250,
    .lvl = 34,
    .species = SPECIES_PILOPOO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLING, MOVE_MUD_BOMB, MOVE_BODY_SLAM, MOVE_STICKY_WEB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_FURRET,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TAKE_DOWN, MOVE_SUBMISSION, MOVE_BULK_UP, MOVE_DOUBLE_TEAM},
    .evs = {252, 0, 252, 0, 0, 4},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_UMBREON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CURSE, MOVE_WISH, MOVE_PROTECT, MOVE_PAYBACK}
    },
    {
    .abilityNum = 3,
    .iv = 250,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_REST, MOVE_WILL_O_WISP}
    },
    {
    .abilityNum = 2,
    .iv = 250,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_SLEEP_TALK, MOVE_GLARE, MOVE_ICE_FANG, MOVE_PSYSHOCK},
    ...
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_MAGIC_MIRROR, MOVE_FLASH_CANNON, MOVE_ASSURANCE},
    .evs = {252, 0, 252, 0, 0, 252},
    },
    {
    .abilityNum = 3,
    ...
    .species = SPECIES_ELITETRIC,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PLASMA_BLADE, MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT, MOVE_EXPLOSION},
    .evs = {126, 0, 126, 0, 0, 4},
    },
    {
    .abilityNum = 2,
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 42,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_CHIP_AWAY, MOVE_EARTHQUAKE, MOVE_SLACK_OFF, MOVE_FIRE_PUNCH}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 24,
    .species = SPECIES_SOLROCK,
    .moves = {MOVE_PSYWAVE, MOVE_ROCK_SLIDE, MOVE_COSMIC_POWER, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Messenger1[] = {
    {
    .iv = 10,
    .lvl = 4,
    .species = SPECIES_DUSKULL,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_CORSOLA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_BLAST, MOVE_HYDRO_PUMP, MOVE_HARDEN, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_DOUBLE_TEAM, MOVE_THUNDER}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    ...
    .lvl = 39,
    .species = SPECIES_VAPOREON,
    .moves = {MOVE_SURF, MOVE_NONE, MOVE_NONE, MOVE_WISH}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sierra[] = {
    {
    .iv = 30,
    .lvl = 21,
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    ...
    .lvl = 28,
    .species = SPECIES_CRACTHORN,
    .moves = {MOVE_LEECH_SEED, MOVE_INGRAIN, MOVE_NONE, MOVE_NEEDLE_ARM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .species = SPECIES_SNORUNT,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ICY_WIND, MOVE_ICE_SHARD, MOVE_HAIL, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 52,
    .species = SPECIES_SWINUB,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BULLDOZE, MOVE_TAKE_DOWN, MOVE_RETURN, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 55,
    .species = SPECIES_SNOUBAUL,
    .moves = {MOVE_SING, MOVE_GLARE, MOVE_ICE_FANG, MOVE_SLASH}
    },
    {
    .iv = 150,
    .lvl = 54,
    ...
    .lvl = 56,
    .species = SPECIES_CLEFABLE,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_MOONBLAST}
    }
};

static const struct TrainerMonItemCustomMoves sParty_WasulaSummitCaveFlobra[] = {
    {
    .abilityNum = 0,
    .iv = 150,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_WasulaSummitCaveEmboryps[] = {
   {
    .abilityNum = 0,
    .iv = 150,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .species = SPECIES_RUTHLASH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BULK_UP, MOVE_POWER_WHIP, MOVE_ICE_PUNCH},
    .evs = {0, 112, 0, 0, 0, 0},
    },
    {
    .abilityNum = 0,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPIKES, MOVE_WHIRLWIND, MOVE_ROOST, MOVE_BRAVE_BIRD},
    .evs = {252, 0, 252, 0, 0, 4},
    },
    {
    .abilityNum = 2,
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_NASTY_PLOT, MOVE_SUCKER_PUNCH, MOVE_DARK_PULSE, MOVE_FIRE_BLAST},
    .evs = {0, 100, 0, 224, 252, 0},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTorchic[] = {
    ...
    .species = SPECIES_RIPTORYPS,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_ELEMENTAL_BREATH, MOVE_DRAGON_DANCE, MOVE_FLARE_BLITZ, MOVE_DRAGON_PULSE},
    .evs = {0, 4, 0, 252, 252, 0},
    },
    {
    .abilityNum = 0,
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DISCHARGE, MOVE_HEAL_BELL, MOVE_ICE_BEAM, MOVE_SURF},
    .evs = {40, 0, 192, 0, 100, 176},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .lvl = 29,
    .species = SPECIES_HOUNDOOM,
    .moves = {MOVE_FIRE_FANG, MOVE_BITE, MOVE_NONE, MOVE_NONE},
    },
    {
    .iv = 150,
    .lvl = 29,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_CONFUSE_RAY, MOVE_AIR_CUTTER, MOVE_WING_ATTACK, MOVE_ACID},
    },
    {
    .iv = 150,
    .lvl = 30,
    ...
    .species = SPECIES_ESCARATACO,
    .moves = {MOVE_ACID_ARMOR, MOVE_BUG_BUZZ, MOVE_BITE, MOVE_NONE},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 27,
    .species = SPECIES_CORSOLA,
    .moves = {MOVE_ROCK_SLIDE, MOVE_AQUA_JET, MOVE_HARDEN, MOVE_WHIRLPOOL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 24,
    .species = SPECIES_RHYHORN,
    .moves = {MOVE_BULLDOZE, MOVE_CHIP_AWAY, MOVE_ROCK_BLAST, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Riley[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_FURY_SWIPES, MOVE_MIND_READER, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 39,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_EXPLOSION, MOVE_SLUDGE_BOMB, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTreecko[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .evs = {126, 0, 126, 0, 0, 4},
    .moves = {MOVE_SPINNING_PUNCH, MOVE_POWER_WHIP, MOVE_BULK_UP, MOVE_RAPID_SPIN}
    },
    {
    .iv = 250,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveMudkip[] = {
    ...
    .lvl = 49,
    .species = SPECIES_AMPHAROS,
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FOCUS_PUNCH, MOVE_LIGHT_SCREEN},
    .evs = {126, 0, 126, 0, 0, 4},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .lvl = 50,
    .species = SPECIES_RUTHLASH,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_CLOSE_COMBAT, MOVE_ENERGY_BALL, MOVE_ROTOTILLER},
    .evs = {126, 0, 126, 0, 0, 4},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTreecko[] = {
    ...
    .lvl = 47,
    .species = SPECIES_SNEASEL,
    .moves = {MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_SLASH, MOVE_HONE_CLAWS},
    .evs = {126, 0, 126, 0, 0, 4},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .lvl = 50,
    .species = SPECIES_RIPTORYPS,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_CRUNCH, MOVE_FLY},
    .evs = {126, 0, 126, 0, 0, 4},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTorchic[] = {
    ...
    .lvl = 47,
    .species = SPECIES_CRADILY,
    .moves = {MOVE_BARRIER, MOVE_TOXIC, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE},
    .evs = {126, 0, 126, 0, 0, 4},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .lvl = 50,
    .species = SPECIES_MECHOBRA,
    .moves = {MOVE_LANDMINE, MOVE_SPIKES, MOVE_SURF, MOVE_RECOVER},
    .evs = {126, 0, 126, 0, 0, 4},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 52,
    .species = SPECIES_KABOWL,
    .moves = {MOVE_EXPLOSION, MOVE_FLY, MOVE_NONE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 53,
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .lvl = 34,
    .species = SPECIES_BUTTERFREE,
    .moves = {MOVE_AIR_SLASH, MOVE_QUIVER_DANCE, MOVE_PSYBEAM, MOVE_BUG_BUZZ}
    },
    {
    .iv = 0,
    .lvl = 34,
    .species = SPECIES_BEEDRILL,
    .moves = {MOVE_AGILITY, MOVE_POISON_JAB, MOVE_CAPTIVATE, MOVE_FELL_STINGER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_GRAVELER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_SMACK_DOWN, MOVE_ROCK_POLISH, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_MEGAHORN, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE},
    .evs = {252, 0, 252, 0, 0, 252},
    },
    {
    .abilityNum = 3,
...
static const struct TrainerMonItemCustomMoves sParty_Koji2[] = { //PAM REMTACH
    {
    .abilityNum = 2,
    .iv = 250,
    .lvl = 70,
...
static const struct TrainerMonItemCustomMoves sParty_Koji3[] = { //DWIGHT
    {
    .abilityNum = 1,
    .iv = 250,
    .lvl = 72,
...
static const struct TrainerMonItemCustomMoves sParty_Koji4[] = { //jim
    {
    .abilityNum =2,
    .iv = 250,
    .lvl = 73,
...
static const struct TrainerMonItemCustomMoves sParty_MegaHoundoomMtChimney[] = {
    {
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .iv = 150,
...
static const struct TrainerMonItemCustomMoves sParty_SummitCavernsLattka1[] = {
    ...
    .species = SPECIES_BILLFALO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HORN_LEECH, MOVE_WORK_UP, MOVE_BRUTAL_SWING, MOVE_MUD_SLAP}
    },
    {
    .abilityNum = 0,
    .iv = 150,
    ...
    .species = SPECIES_SABLIZZARD,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICICLE_SPEAR, MOVE_AGILITY, MOVE_BODY_SLAM, MOVE_NONE}
    },
    {
    .iv = 150,
    .lvl = 34,
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_LOW_KICK, MOVE_SWIFT}
    }
};

static const struct TrainerMonItemCustomMoves sParty_SummitCavernsLattka2[] = {
    {
    .abilityNum = 0,
    .iv = 150,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_JohnChampionsHallMudkip[] = {
    ...
    .lvl = 62,
    .species = SPECIES_SCYTHER,
    .moves = {MOVE_BUG_BITE, MOVE_AERIAL_ACE, MOVE_ROCK_SMASH, MOVE_SWORDS_DANCE},
    .evs = {112, 150, 0, 120, 0, 100},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    .iv = 255,
    ...
    .lvl = 62,
    .species = SPECIES_AMPHAROS,
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FOCUS_BLAST, MOVE_LIGHT_SCREEN},
    .evs = {252, 0, 0, 0, 80, 176},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    .abilityNum = 3,
    ...
    .lvl = 62,
    .species = SPECIES_MACHAMP,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_PAYBACK, MOVE_STONE_EDGE, MOVE_BULLET_PUNCH},
    .evs = {0, 151, 4, 151, 0, 20},
    }
};

static const struct TrainerMonItemCustomMoves sParty_JohnChampionsHallTreecko[] = {
    {
    .heldItem = ITEM_LIFE_ORB,
    .iv = 255,
    .lvl = 62,
    ...
    .lvl = 64,
    .species = SPECIES_RIPTORYPS,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_ELEMENTAL_BREATH, MOVE_FLY},
    .evs = {126, 150, 126, 0, 0, 4},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    .abilityNum = 2,
...
static const struct TrainerMonItemCustomMoves sParty_JohnChampionsHallTorchic[] = {
    {
    .abilityNum = 2,
    .heldItem = ITEM_SITRUS_BERRY,
    .iv = 255,
    ...
    .lvl = 64,
    .species = SPECIES_MECHOBRA,
    .moves = {MOVE_LANDMINE, MOVE_SPIKES, MOVE_SURF, MOVE_AQUA_RING},
    .evs = {252, 0, 151, 0, 0, 151},
    },
    {
    .heldItem = ITEM_SITRUS_BERRY,
    .abilityNum = 2,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eli2[] = {
    {
    .iv = 20,
    .lvl = 18,
    .species = SPECIES_GEODUDE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Amber[] = {
    {
    .iv = 15,
    .lvl = 17,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bruno2[] = {
    {
    .iv = 30,
    .lvl = 20,
    .species = SPECIES_MACHOP,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lila2[] = {
    {
    .iv = 25,
    .lvl = 18,
    .species = SPECIES_GROWLITHE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Grayson[] = {
    {
    .iv = 30,
    .lvl = 21,
    .species = SPECIES_SANDSLASH,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Clara[] = {
    {
    .iv = 25,
    .lvl = 19,
    .species = SPECIES_ABRA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ezra[] = {
    {
    .iv = 25,
    .lvl = 20,
    .species = SPECIES_DROWZEE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nina[] = {
    {
    .iv = 30,
    .lvl = 21,
