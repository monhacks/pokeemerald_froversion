...
const u16 gEasyChatWordsByLetter_F[] = {
    ...
    EC_POKEMON2(BUCCANILE),
    EC_POKEMON2(BUCCANITE),
    EC_POKEMON2(BUCCAFEAR),
    EC_POKEMON2(KOPIRAR),
    EC_POKEMON2(KOPISPAR),
    EC_POKEMON2(KOPIROAR),
    EC_POKEMON2(WALLITE),
    EC_POKEMON2(MAROWAK_ALOLAN),
    EC_POKEMON2(WALLOCK),
    EC_POKEMON2(WARSOCK),
    EC_POKEMON2(KICWINDO),
    EC_POKEMON2(HAUSODOOM),
    EC_POKEMON2(DROPYCE),
    EC_POKEMON2(METAROURA),
    EC_POKEMON2(CHERNABOG),
    EC_POKEMON2(CARLILE),
