...
static const union AnimCmd *const sAnims_JohnM[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Jerett[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_OfficeJim[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Dawson[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Lattka[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_JERETT] = sAnims_Jerett,
    ...
    [TRAINER_PIC_MAGA_GRUNT_A] = sAnims_FroversionTrainers,
    [TRAINER_PIC_MAGA_GRUNT_B] = sAnims_FroversionTrainers,
    [TRAINER_PIC_MAGA_GRUNTS] = sAnims_FroversionTrainers,
    [TRAINER_PIC_NIKE] = sAnims_FroversionTrainers,
    [TRAINER_PIC_ANTIFA_GRUNT] = sAnims_FroversionTrainers,
    [TRAINER_PIC_KOSTIW] = sAnims_FroversionTrainers,
    ...
    [TRAINER_PIC_MEWTWO] = sAnims_FroversionTrainers,
    };
