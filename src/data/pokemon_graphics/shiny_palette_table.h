const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BUCCANILE, gMonShinyPalette_Buccanile),
    SPECIES_SHINY_PAL(BUCCANITE, gMonShinyPalette_Buccanite),
    SPECIES_SHINY_PAL(BUCCAFEAR, gMonShinyPalette_Buccafear),
    SPECIES_SHINY_PAL(KOPIRAR, gMonShinyPalette_Kopirar),
    SPECIES_SHINY_PAL(KOPISPAR, gMonShinyPalette_Kopispar),
    SPECIES_SHINY_PAL(KOPIROAR, gMonShinyPalette_Kopiroar),
    SPECIES_SHINY_PAL(WALLITE, gMonShinyPalette_Wallite),
    SPECIES_SHINY_PAL(WALLOCK, gMonShinyPalette_Wallock),
    SPECIES_SHINY_PAL(WARSOCK, gMonShinyPalette_Warsock),
    SPECIES_SHINY_PAL(KICWINDO, gMonShinyPalette_Kicwindo),
    SPECIES_SHINY_PAL(HAUSODOOM, gMonShinyPalette_Hausodoom),
    SPECIES_SHINY_PAL(DROPYCE, gMonShinyPalette_Dropyce),
    SPECIES_SHINY_PAL(METAROURA, gMonShinyPalette_Metaroura),
    SPECIES_SHINY_PAL(CHERNABOG, gMonShinyPalette_Chernabog),
    SPECIES_SHINY_PAL(CARLILE, gMonShinyPalette_Carlile),
