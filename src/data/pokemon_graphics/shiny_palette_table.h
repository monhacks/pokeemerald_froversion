const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(SHADOW_CHARIZARD, gMonShinyPalette_Shadow_Charizard),
    SPECIES_SHINY_PAL(ABYSSALDRAGONTHIRDEVO, gMonShinyPalette_Abyssaldragonthirdevo),
    SPECIES_SHINY_PAL(ABYSSALDRAGONSECONDEVO, gMonShinyPalette_Abyssaldragonsecondevo),
    SPECIES_SHINY_PAL(ABYSSALDRAGONFIRSTEVO, gMonShinyPalette_Abyssaldragonfirstevo),
    SPECIES_SHINY_PAL(CHEETO, gMonShinyPalette_Cheeto),
    ...
    SPECIES_SHINY_PAL(ARIADOS_GHOST, gMonShinyPalette_Ariados_Ghost),
    SPECIES_SHINY_PAL(FILLER_38, gMonShinyPalette_Filler_38),
    SPECIES_SHINY_PAL(CHARIZARD_X, gMonShinyPalette_Charizard_X),
