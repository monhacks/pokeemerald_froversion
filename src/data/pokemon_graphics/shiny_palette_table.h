const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(CACTAR, gMonShinyPalette_Cactar),
    SPECIES_SHINY_PAL(CRACTHORN, gMonShinyPalette_Cracthorn),
    ...
    SPECIES_SHINY_PAL(REDEYES, gMonShinyPalette_Filler_1),
    SPECIES_SHINY_PAL(MAROWAK_ALOLAN, gMonShinyPalette_Marowak_Alolan),
    SPECIES_SHINY_PAL(CONTRARAM, gMonShinyPalette_Contraram),
    SPECIES_SHINY_PAL(PLASMUNG, gMonShinyPalette_Plasmung),
    SPECIES_SHINY_PAL(GRUNTAZE, gMonShinyPalette_Gruntaze),
    SPECIES_SHINY_PAL(ELITETRIC, gMonShinyPalette_Elitetric),
    SPECIES_SHINY_PAL(MEGA_DEWGONG, gMonShinyPalette_Mega_Dewgong),
