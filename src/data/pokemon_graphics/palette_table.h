const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(SHADOW_CHARIZARD, gMonPalette_Shadow_Charizard),
    SPECIES_PAL(ABYSSALDRAGONTHIRDEVO, gMonPalette_Abyssaldragonthirdevo),
    SPECIES_PAL(ABYSSALDRAGONSECONDEVO, gMonPalette_Abyssaldragonsecondevo),
    SPECIES_PAL(ABYSSALDRAGONFIRSTEVO, gMonPalette_Abyssaldragonfirstevo),
    SPECIES_PAL(CHEETO, gMonPalette_Cheeto),
    ...
    SPECIES_PAL(ARIADOS_GHOST, gMonPalette_Ariados_Ghost),
    SPECIES_PAL(FILLER_38, gMonPalette_Filler_38),
    SPECIES_PAL(CHARIZARD_X, gMonPalette_Charizard_X),
