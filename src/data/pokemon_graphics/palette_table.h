const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(RASCALOOT, gMonPalette_Rascaloot),
    SPECIES_PAL(BANDITHUG, gMonPalette_Bandithug),
    SPECIES_PAL(RUTHLASH, gMonPalette_Ruthlash),
    SPECIES_PAL(FLOBRA, gMonPalette_Flobra),
    SPECIES_PAL(MORPHLO, gMonPalette_Morphlo),
    SPECIES_PAL(MECHOBRA, gMonPalette_Mechobra),
    SPECIES_PAL(EMBORYPS, gMonPalette_Emboryps),
    SPECIES_PAL(HUNTORYPS, gMonPalette_Huntoryps),
    SPECIES_PAL(RIPTORYPS, gMonPalette_Riptoryps),
    SPECIES_PAL(SPIRITOMB, gMonPalette_Spiritomb),
    SPECIES_PAL(SNOUMESE, gMonPalette_Snoumese),
    SPECIES_PAL(SNOUBAUL, gMonPalette_Snoubaul),
    SPECIES_PAL(NEVAWOK, gMonPalette_Nevawok),
    SPECIES_PAL(WOKAGIN, gMonPalette_Wokagin),
    SPECIES_PAL(VAYPING, gMonPalette_Vayping),
    SPECIES_PAL(KABOWL, gMonPalette_Kabowl),
    SPECIES_PAL(BOWLAST, gMonPalette_Bowlast),
    SPECIES_PAL(PHOKAI, gMonPalette_Phokai),
    SPECIES_PAL(PHOTASM, gMonPalette_Photasm),
    SPECIES_PAL(PHOTOGEIST, gMonPalette_Photogeist),
    SPECIES_PAL(TOGEKISS, gMonPalette_Togekiss),
    SPECIES_PAL(OTDORBLE, gMonPalette_Otdorble),
    SPECIES_PAL(LUTRADOR, gMonPalette_Lutrador),
    SPECIES_PAL(DUMBELLION, gMonPalette_Dumbellion),
    SPECIES_PAL(BARBELLION, gMonPalette_Barbellion),
    SPECIES_PAL(OCTIRE, gMonPalette_Octire),
    SPECIES_PAL(INVERTEBRAKE, gMonPalette_Invertebrake),
    SPECIES_PAL(HAAGLET, gMonPalette_Haaglet),
    SPECIES_PAL(WARTHAAG, gMonPalette_Warthaag),
    SPECIES_PAL(TAQUITTLE, gMonPalette_Taquittle),
    SPECIES_PAL(ESCARATACO, gMonPalette_Escarataco),
    SPECIES_PAL(CHAD_BUG_1, gMonPalette_Chad_Bug_1),
    SPECIES_PAL(CHAD_BUG_2, gMonPalette_Chad_Bug_2),
    SPECIES_PAL(PILOPOO, gMonPalette_Pilopoo),
    SPECIES_PAL(BILLFALO, gMonPalette_Billfalo),
    SPECIES_PAL(SABLIZZARD, gMonPalette_Sablizzard),
    SPECIES_PAL(PASSIMIAN, gMonPalette_Passimian),
    SPECIES_PAL(ROCK_CACTUS_STAGE_1, gMonPalette_Rock_Cactus_Stage_1),
    SPECIES_PAL(ROCK_CACTUS_STAGE_2, gMonPalette_Rock_Cactus_Stage_2),
    SPECIES_PAL(CRACKTUSS, gMonPalette_Cracktuss),
    SPECIES_PAL(DRACASTER, gMonPalette_Dracaster),
    SPECIES_PAL(BLUE EYES, gMonPalette_Blue Eyes),
    SPECIES_PAL(FILLER_1, gMonPalette_Filler_1),
    SPECIES_PAL(FILLER_2, gMonPalette_Filler_2),
    SPECIES_PAL(FILLER_3, gMonPalette_Filler_3),
    SPECIES_PAL(FILLER_4, gMonPalette_Filler_4),
    SPECIES_PAL(FILLER_5, gMonPalette_Filler_5),
    SPECIES_PAL(FILLER_6, gMonPalette_Filler_6),
    SPECIES_PAL(FILLER_7, gMonPalette_Filler_7),
    SPECIES_PAL(FILLER_8, gMonPalette_Filler_8),
    SPECIES_PAL(FILLER_9, gMonPalette_Filler_9),
    SPECIES_PAL(FILLER_10, gMonPalette_Filler_10),
    SPECIES_PAL(FILLER_11, gMonPalette_Filler_11),
    SPECIES_PAL(FILLER_12, gMonPalette_Filler_12),
    SPECIES_PAL(FILLER_13, gMonPalette_Filler_13),
    SPECIES_PAL(FILLER_14, gMonPalette_Filler_14),
    SPECIES_PAL(FILLER_15, gMonPalette_Filler_15),
    SPECIES_PAL(FILLER_16, gMonPalette_Filler_16),
    SPECIES_PAL(FILLER_17, gMonPalette_Filler_17),
    SPECIES_PAL(FILLER_18, gMonPalette_Filler_18),
    SPECIES_PAL(FILLER_19, gMonPalette_Filler_19),
    SPECIES_PAL(FILLER_20, gMonPalette_Filler_20),
    SPECIES_PAL(FILLER_21, gMonPalette_Filler_21),
    SPECIES_PAL(FILLER_22, gMonPalette_Filler_22),
    SPECIES_PAL(FILLER_23, gMonPalette_Filler_23),
    SPECIES_PAL(FILLER_24, gMonPalette_Filler_24),
    SPECIES_PAL(FILLER_25, gMonPalette_Filler_25),
    SPECIES_PAL(FILLER_26, gMonPalette_Filler_26),
    SPECIES_PAL(FILLER_27, gMonPalette_Filler_27),
    SPECIES_PAL(FILLER_28, gMonPalette_Filler_28),
    SPECIES_PAL(FILLER_29, gMonPalette_Filler_29),
    SPECIES_PAL(FILLER_30, gMonPalette_Filler_30),
    SPECIES_PAL(FILLER_31, gMonPalette_Filler_31),
    SPECIES_PAL(FILLER_32, gMonPalette_Filler_32),
    SPECIES_PAL(FILLER_33, gMonPalette_Filler_33),
    SPECIES_PAL(FILLER_34, gMonPalette_Filler_34),
    SPECIES_PAL(FILLER_35, gMonPalette_Filler_35),
    SPECIES_PAL(FILLER_36, gMonPalette_Filler_36),
    SPECIES_PAL(FILLER_37, gMonPalette_Filler_37),
    SPECIES_PAL(FILLER_38, gMonPalette_Filler_38),
    SPECIES_PAL(FILLER_39, gMonPalette_Filler_39),
    SPECIES_PAL(FILLER_40, gMonPalette_Filler_40),
    SPECIES_PAL(FILLER_41, gMonPalette_Filler_41),
    SPECIES_PAL(FILLER_42, gMonPalette_Filler_42),
