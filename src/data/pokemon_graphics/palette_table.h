const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(CACTAR, gMonPalette_Cactar),
    SPECIES_PAL(CRACTHORN, gMonPalette_Cracthorn),
    ...
    SPECIES_PAL(REDEYES, gMonPalette_Filler_1),
    SPECIES_PAL(MAROWAK_ALOLAN, gMonPalette_Marowak_Alolan),
    SPECIES_PAL(CONTRARAM, gMonPalette_Contraram),
    SPECIES_PAL(PLASMUNG, gMonPalette_Plasmung),
    SPECIES_PAL(GRUNTAZE, gMonPalette_Gruntaze),
    SPECIES_PAL(ELITETRIC, gMonPalette_Elitetric),
    SPECIES_PAL(MEGA_DEWGONG, gMonPalette_Mega_Dewgong),
