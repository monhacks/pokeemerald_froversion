const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BUCCANILE, gMonPalette_Buccanile),
    SPECIES_PAL(BUCCANITE, gMonPalette_Buccanite),
    SPECIES_PAL(BUCCAFEAR, gMonPalette_Buccafear),
    SPECIES_PAL(KOPIRAR, gMonPalette_Kopirar),
    SPECIES_PAL(KOPISPAR, gMonPalette_Kopispar),
    SPECIES_PAL(KOPIROAR, gMonPalette_Kopiroar),
    SPECIES_PAL(WALLITE, gMonPalette_Wallite),
    SPECIES_PAL(WALLOCK, gMonPalette_Wallock),
    SPECIES_PAL(WARSOCK, gMonPalette_Warsock),
    SPECIES_PAL(KICWINDO, gMonPalette_Kicwindo),
    SPECIES_PAL(HAUSODOOM, gMonPalette_Hausodoom),
    SPECIES_PAL(DROPYCE, gMonPalette_Dropyce),
    SPECIES_PAL(METAROURA, gMonPalette_Metaroura),
    SPECIES_PAL(CHERNABOG, gMonPalette_Chernabog),
    SPECIES_PAL(CARLILE, gMonPalette_Carlile),
