...
// Gen III
    ...
    //Froversion Fakemon
    SPECIES_SPRITE(RASCALOOT, gMonStillFrontPic_Rascaloot),
    SPECIES_SPRITE(BANDITHUG, gMonStillFrontPic_Bandithug),
    SPECIES_SPRITE(RUTHLASH, gMonStillFrontPic_Ruthlash),
    SPECIES_SPRITE(FLOBRA, gMonStillFrontPic_Flobra),
    SPECIES_SPRITE(MORPHLO, gMonStillFrontPic_Morphlo),
    SPECIES_SPRITE(MECHOBRA, gMonStillFrontPic_Mechobra),
    SPECIES_SPRITE(EMBORYPS, gMonStillFrontPic_Emboryps),
    SPECIES_SPRITE(HUNTORYPS, gMonStillFrontPic_Huntoryps),
    SPECIES_SPRITE(RIPTORYPS, gMonStillFrontPic_Riptoryps),
    SPECIES_SPRITE(SPIRITOMB, gMonStillFrontPic_Spiritomb),
    SPECIES_SPRITE(SNOUMESE, gMonStillFrontPic_Snoumese),
    SPECIES_SPRITE(SNOUBAUL, gMonStillFrontPic_Snoubaul),
    SPECIES_SPRITE(NEVAWOK, gMonStillFrontPic_Nevawok),
    SPECIES_SPRITE(WOKAGIN, gMonStillFrontPic_Wokagin),
    SPECIES_SPRITE(VAYPING, gMonStillFrontPic_Vayping),
    SPECIES_SPRITE(KABOWL, gMonStillFrontPic_Kabowl),
    SPECIES_SPRITE(BOWLAST, gMonStillFrontPic_Bowlast),
    SPECIES_SPRITE(PHOKAI, gMonStillFrontPic_Phokai),
    SPECIES_SPRITE(PHOTASM, gMonStillFrontPic_Photasm),
    SPECIES_SPRITE(PHOTOGEIST, gMonStillFrontPic_Photogeist),
    SPECIES_SPRITE(TOGEKISS, gMonStillFrontPic_Togekiss),
    SPECIES_SPRITE(OTDORBLE, gMonStillFrontPic_Otdorble),
    SPECIES_SPRITE(LUTRADOR, gMonStillFrontPic_Lutrador),
    SPECIES_SPRITE(DUMBELLION, gMonStillFrontPic_Dumbellion),
    SPECIES_SPRITE(BARBELLION, gMonStillFrontPic_Barbellion),
    SPECIES_SPRITE(OCTIRE, gMonStillFrontPic_Octire),
    SPECIES_SPRITE(INVERTEBRAKE, gMonStillFrontPic_Invertebrake),
    SPECIES_SPRITE(HAAGLET, gMonStillFrontPic_Haaglet),
    SPECIES_SPRITE(WARTHAAG, gMonStillFrontPic_Warthaag),
    SPECIES_SPRITE(TAQUITTLE, gMonStillFrontPic_Taquittle),
    SPECIES_SPRITE(ESCARATACO, gMonStillFrontPic_Escarataco),
    SPECIES_SPRITE(CHAD_BUG_1, gMonStillFrontPic_Chad_Bug_1),
    SPECIES_SPRITE(CHAD_BUG_2, gMonStillFrontPic_Chad_Bug_2),
    SPECIES_SPRITE(PILOPOO, gMonStillFrontPic_Pilopoo),
    SPECIES_SPRITE(BILLFALO, gMonStillFrontPic_Billfalo),
    SPECIES_SPRITE(SABLIZZARD, gMonStillFrontPic_Sablizzard),
    SPECIES_SPRITE(PASSIMIAN, gMonStillFrontPic_Passimian),
    SPECIES_SPRITE(CACTAR, gMonStillFrontPic_Cactar),
    SPECIES_SPRITE(CRACTHORN, gMonStillFrontPic_Cracthorn),
    SPECIES_SPRITE(CRACKTUSS, gMonStillFrontPic_Cracktuss),
    SPECIES_SPRITE(DRACASTER, gMonStillFrontPic_Dracaster),
    SPECIES_SPRITE(BLUE_EYES, gMonStillFrontPic_Blue_Eyes),
    SPECIES_SPRITE(REDEYES, gMonStillFrontPic_Filler_1),
    SPECIES_SPRITE(MAROWAK_ALOLAN, gMonStillFrontPic_Marowak_Alolan),
    SPECIES_SPRITE(CONTRARAM, gMonStillFrontPic_Contraram),
    SPECIES_SPRITE(PLASMUNG, gMonStillFrontPic_Plasmung),
    SPECIES_SPRITE(GRUNTAZE, gMonStillFrontPic_Gruntaze),
    SPECIES_SPRITE(ELITETRIC, gMonStillFrontPic_Elitetric),
    SPECIES_SPRITE(MEGA_DEWGONG, gMonStillFrontPic_Mega_Dewgong),
    SPECIES_SPRITE(FILLER_8, gMonStillFrontPic_Filler_8),
    SPECIES_SPRITE(FILLER_9, gMonStillFrontPic_Filler_9),
    SPECIES_SPRITE(FRENTOAD, gMonStillFrontPic_Frentoad),
    SPECIES_SPRITE(RABATOAST, gMonStillFrontPic_Rabatoast),
    SPECIES_SPRITE(SHADOW_CHARIZARD, gMonStillFrontPic_Shadow_Charizard),
    SPECIES_SPRITE(ABYSSALDRAGONTHIRDEVO, gMonStillFrontPic_Abyssaldragonthirdevo),
    SPECIES_SPRITE(ABYSSALDRAGONSECONDEVO, gMonStillFrontPic_Abyssaldragonsecondevo),
    SPECIES_SPRITE(ABYSSALDRAGONFIRSTEVO, gMonStillFrontPic_Abyssaldragonfirstevo),
    SPECIES_SPRITE(CHEETO, gMonStillFrontPic_Cheeto),
    SPECIES_SPRITE(FILLER_17, gMonStillFrontPic_Filler_17),
    SPECIES_SPRITE(FILLER_18, gMonStillFrontPic_Filler_18),
    SPECIES_SPRITE(FILLER_19, gMonStillFrontPic_Filler_19),
    SPECIES_SPRITE(FILLER_20, gMonStillFrontPic_Filler_20),
    SPECIES_SPRITE(FILLER_21, gMonStillFrontPic_Filler_21),
    SPECIES_SPRITE(FILLER_22, gMonStillFrontPic_Filler_22),
    SPECIES_SPRITE(FILLER_23, gMonStillFrontPic_Filler_23),
    SPECIES_SPRITE(FILLER_24, gMonStillFrontPic_Filler_24),
    SPECIES_SPRITE(FILLER_25, gMonStillFrontPic_Filler_25),
    SPECIES_SPRITE(FILLER_26, gMonStillFrontPic_Filler_26),
    SPECIES_SPRITE(FILLER_27, gMonStillFrontPic_Filler_27),
    SPECIES_SPRITE(FILLER_28, gMonStillFrontPic_Filler_28),
    SPECIES_SPRITE(FILLER_29, gMonStillFrontPic_Filler_29),
    SPECIES_SPRITE(FILLER_30, gMonStillFrontPic_Filler_30),
    SPECIES_SPRITE(FILLER_31, gMonStillFrontPic_Filler_31),
    SPECIES_SPRITE(FILLER_32, gMonStillFrontPic_Filler_32),
    SPECIES_SPRITE(FILLER_33, gMonStillFrontPic_Filler_33),
    SPECIES_SPRITE(FILLER_34, gMonStillFrontPic_Filler_34),
    SPECIES_SPRITE(FILLER_35, gMonStillFrontPic_Filler_35),
    SPECIES_SPRITE(FILLER_36, gMonStillFrontPic_Filler_36),
    SPECIES_SPRITE(ARIADOS_GHOST, gMonStillFrontPic_Ariados_Ghost),
    SPECIES_SPRITE(FILLER_38, gMonStillFrontPic_Filler_38),
    SPECIES_SPRITE(CHARIZARD_X, gMonStillFrontPic_Charizard_X),
    SPECIES_SPRITE(WARKLOCK, gMonStillFrontPic_Warklock),
    SPECIES_SPRITE(CLOCLOCK, gMonStillFrontPic_Cloclock),
    SPECIES_SPRITE(SPIRETT, gMonStillFrontPic_Spirett),
    //metagross forms
    SPECIES_SPRITE(METAGROSS_FIRE, gMonStillFrontPic_Metagross_Fire),
    SPECIES_SPRITE(METAGROSS_WATER, gMonStillFrontPic_Metagross_Water),
    SPECIES_SPRITE(METAGROSS_GRASS, gMonStillFrontPic_Metagross_Grass),
    SPECIES_SPRITE(METAGROSS_ELECTRIC, gMonStillFrontPic_Metagross_Electric),
    SPECIES_SPRITE(METAGROSS_NORMAL, gMonStillFrontPic_Metagross_Normal),
    SPECIES_SPRITE(METAGROSS_ICE, gMonStillFrontPic_Metagross_Ice),
    SPECIES_SPRITE(METAGROSS_FIGHTING, gMonStillFrontPic_Metagross_Fighting),
    SPECIES_SPRITE(METAGROSS_POISON, gMonStillFrontPic_Metagross_Poison),
    SPECIES_SPRITE(METAGROSS_GROUND, gMonStillFrontPic_Metagross_Ground),
    SPECIES_SPRITE(METAGROSS_FLYING, gMonStillFrontPic_Metagross_Flying),
    SPECIES_SPRITE(METAGROSS_BUG, gMonStillFrontPic_Metagross_Bug),
    SPECIES_SPRITE(METAGROSS_GHOST, gMonStillFrontPic_Metagross_Ghost),
    SPECIES_SPRITE(METAGROSS_DRAGON, gMonStillFrontPic_Metagross_Dragon),
