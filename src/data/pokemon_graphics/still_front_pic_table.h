...
// Gen III
    ...
    SPECIES_SPRITE(BUCCANILE, gMonStillFrontPic_Buccanile),
    SPECIES_SPRITE(BUCCANITE, gMonStillFrontPic_Buccanite),
    SPECIES_SPRITE(BUCCAFEAR, gMonStillFrontPic_Buccafear),
    SPECIES_SPRITE(KOPIRAR, gMonStillFrontPic_Kopirar),
    SPECIES_SPRITE(KOPISPAR, gMonStillFrontPic_Kopispar),
    SPECIES_SPRITE(KOPIROAR, gMonStillFrontPic_Kopiroar),
    SPECIES_SPRITE(WALLITE, gMonStillFrontPic_Wallite),
    SPECIES_SPRITE(WALLOCK, gMonStillFrontPic_Wallock),
    SPECIES_SPRITE(WARSOCK, gMonStillFrontPic_Warsock),
    SPECIES_SPRITE(KICWINDO, gMonStillFrontPic_Kicwindo),
    SPECIES_SPRITE(HAUSODOOM, gMonStillFrontPic_Hausodoom),
    SPECIES_SPRITE(DROPYCE, gMonStillFrontPic_Dropyce),
    SPECIES_SPRITE(METAROURA, gMonStillFrontPic_Metaroura),
    SPECIES_SPRITE(CHERNABOG, gMonStillFrontPic_Chernabog),
    SPECIES_SPRITE(CARLILE, gMonStillFrontPic_Carlile),
