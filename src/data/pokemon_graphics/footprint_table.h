const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_FLOBRA] = gMonFootprint_Flobra,
    [SPECIES_MORPHLO] = gMonFootprint_Morphlo,
    [SPECIES_MECHOBRA] = gMonFootprint_Mechobra,
    [SPECIES_EMBORYPS] = gMonFootprint_Emboryps,
    [SPECIES_HUNTORYPS] = gMonFootprint_Huntoryps,
    [SPECIES_RIPTORYPS] = gMonFootprint_Riptoryps,
    [SPECIES_SPIRITOMB] = gMonFootprint_Spiritomb,
    [SPECIES_SNOUMESE] = gMonFootprint_Snoumese,
    [SPECIES_SNOUBAUL] = gMonFootprint_Snoubaul,
    [SPECIES_NEVAWOK] = gMonFootprint_Nevawok,
    [SPECIES_WOKAGIN] = gMonFootprint_Wokagin,
    [SPECIES_VAYPING] = gMonFootprint_Vayping,
    [SPECIES_KABOWL] = gMonFootprint_Kabowl,
    [SPECIES_BOWLAST] = gMonFootprint_Bowlast,
    [SPECIES_PHOKAI] = gMonFootprint_Phokai,
    [SPECIES_PHOTASM] = gMonFootprint_Photasm,
    [SPECIES_PHOTOGEIST] = gMonFootprint_Photogeist,
    [SPECIES_TOGEKISS] = gMonFootprint_Togekiss,
    [SPECIES_OTDORBLE] = gMonFootprint_Otdorble,
    [SPECIES_LUTRADOR] = gMonFootprint_Lutrador,
    [SPECIES_DUMBELLION] = gMonFootprint_Dumbellion,
    [SPECIES_BARBELLION] = gMonFootprint_Barbellion,
    [SPECIES_OCTIRE] = gMonFootprint_Octire,
    [SPECIES_INVERTEBRAKE] = gMonFootprint_Invertebrake,
    [SPECIES_HAAGLET] = gMonFootprint_Haaglet,
    [SPECIES_WARTHAAG] = gMonFootprint_Warthaag,
    [SPECIES_TAQUITTLE] = gMonFootprint_Taquittle,
    [SPECIES_ESCARATACO] = gMonFootprint_Escarataco,
    [SPECIES_CHAD_BUG_1] = gMonFootprint_Chad_Bug_1,
    [SPECIES_CHAD_BUG_2] = gMonFootprint_Chad_Bug_2,
    [SPECIES_PILOPOO] = gMonFootprint_Pilopoo,
    [SPECIES_BILLFALO] = gMonFootprint_Billfalo,
    [SPECIES_SABLIZZARD] = gMonFootprint_Sablizzard,
    [SPECIES_PASSIMIAN] = gMonFootprint_Passimian,
    [SPECIES_CACTAR] = gMonFootprint_Cactar,
    [SPECIES_CRACTHORN] = gMonFootprint_Cracthorn,
    [SPECIES_CRACKTUSS] = gMonFootprint_Cracktuss,
    [SPECIES_DRACASTER] = gMonFootprint_Dracaster,
    [SPECIES_BLUE_EYES] = gMonFootprint_Blue_Eyes,
    [SPECIES_REDEYES] = gMonFootprint_Filler_1,
    [SPECIES_MAROWAK_ALOLAN] = gMonFootprint_Marowak_Alolan,
    [SPECIES_CONTRARAM] = gMonFootprint_Contraram,
    [SPECIES_PLASMUNG] = gMonFootprint_Plasmung,
    [SPECIES_GRUNTAZE] = gMonFootprint_Gruntaze,
    [SPECIES_ELITETRIC] = gMonFootprint_Elitetric,
    [SPECIES_MEGA_DEWGONG] = gMonFootprint_Mega_Dewgong,
    [SPECIES_FILLER_8] = gMonFootprint_Filler_8,
    [SPECIES_FILLER_9] = gMonFootprint_Filler_9,
    [SPECIES_FRENTOAD] = gMonFootprint_Frentoad,
    [SPECIES_RABATOAST] = gMonFootprint_Rabatoast,
    [SPECIES_SHADOW_CHARIZARD] = gMonFootprint_Shadow_Charizard,
    [SPECIES_ABYSSALDRAGONTHIRDEVO] = gMonFootprint_Abyssaldragonthirdevo,
    [SPECIES_ABYSSALDRAGONSECONDEVO] = gMonFootprint_Abyssaldragonsecondevo,
    [SPECIES_ABYSSALDRAGONFIRSTEVO] = gMonFootprint_Abyssaldragonfirstevo,
    [SPECIES_CHEETO] = gMonFootprint_Cheeto,
    [SPECIES_FILLER_17] = gMonFootprint_Filler_17,
    [SPECIES_FILLER_18] = gMonFootprint_Filler_18,
    [SPECIES_FILLER_19] = gMonFootprint_Filler_19,
    [SPECIES_FILLER_20] = gMonFootprint_Filler_20,
    [SPECIES_FILLER_21] = gMonFootprint_Filler_21,
    [SPECIES_FILLER_22] = gMonFootprint_Filler_22,
    [SPECIES_FILLER_23] = gMonFootprint_Filler_23,
    [SPECIES_FILLER_24] = gMonFootprint_Filler_24,
    [SPECIES_FILLER_25] = gMonFootprint_Filler_25,
    [SPECIES_FILLER_26] = gMonFootprint_Filler_26,
    [SPECIES_FILLER_27] = gMonFootprint_Filler_27,
    [SPECIES_FILLER_28] = gMonFootprint_Filler_28,
    [SPECIES_FILLER_29] = gMonFootprint_Filler_29,
    [SPECIES_FILLER_30] = gMonFootprint_Filler_30,
    [SPECIES_FILLER_31] = gMonFootprint_Filler_31,
    [SPECIES_FILLER_32] = gMonFootprint_Filler_32,
    [SPECIES_FILLER_33] = gMonFootprint_Filler_33,
    [SPECIES_FILLER_34] = gMonFootprint_Filler_34,
    [SPECIES_FILLER_35] = gMonFootprint_Filler_35,
    [SPECIES_FILLER_36] = gMonFootprint_Filler_36,
    [SPECIES_ARIADOS_GHOST] = gMonFootprint_Ariados_Ghost,
    [SPECIES_FILLER_38] = gMonFootprint_Filler_38,
    [SPECIES_CHARIZARD_X] = gMonFootprint_Charizard_X,
