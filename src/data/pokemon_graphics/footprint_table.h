const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BUCCANILE] = gMonFootprint_Buccanile,
    [SPECIES_BUCCANITE] = gMonFootprint_Buccanite,
    [SPECIES_BUCCAFEAR] = gMonFootprint_Buccafear,
    [SPECIES_KOPIRAR] = gMonFootprint_Kopirar,
    [SPECIES_KOPISPAR] = gMonFootprint_Kopispar,
    [SPECIES_KOPIROAR] = gMonFootprint_Kopiroar,
    [SPECIES_WALLITE] = gMonFootprint_Wallite,
    [SPECIES_WALLOCK] = gMonFootprint_Wallock,
    [SPECIES_WARSOCK] = gMonFootprint_Warsock,
    [SPECIES_KICWINDO] = gMonFootprint_Kicwindo,
    [SPECIES_HAUSODOOM] = gMonFootprint_Hausodoom,
    [SPECIES_DROPYCE] = gMonFootprint_Dropyce,
    [SPECIES_METAROURA] = gMonFootprint_Metaroura,
    [SPECIES_CHERNABOG] = gMonFootprint_Chernabog,
    [SPECIES_CARLILE] = gMonFootprint_Carlile,
