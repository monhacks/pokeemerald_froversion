const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_ROCK_CACTUS_STAGE_1] = gMonFootprint_Rock_Cactus_Stage_1,
    [SPECIES_ROCK_CACTUS_STAGE_2] = gMonFootprint_Rock_Cactus_Stage_2,
    [SPECIES_CRACKTUSS] = gMonFootprint_Cracktuss,
    [SPECIES_DRACASTER] = gMonFootprint_Dracaster,
    [SPECIES_BLUE EYES] = gMonFootprint_Blue Eyes,
    [SPECIES_FILLER_1] = gMonFootprint_Filler_1,
    [SPECIES_FILLER_2] = gMonFootprint_Filler_2,
    [SPECIES_FILLER_3] = gMonFootprint_Filler_3,
    [SPECIES_FILLER_4] = gMonFootprint_Filler_4,
    [SPECIES_FILLER_5] = gMonFootprint_Filler_5,
    [SPECIES_FILLER_6] = gMonFootprint_Filler_6,
    [SPECIES_FILLER_7] = gMonFootprint_Filler_7,
    [SPECIES_FILLER_8] = gMonFootprint_Filler_8,
    [SPECIES_FILLER_9] = gMonFootprint_Filler_9,
    [SPECIES_FILLER_10] = gMonFootprint_Filler_10,
    [SPECIES_FILLER_11] = gMonFootprint_Filler_11,
    [SPECIES_FILLER_12] = gMonFootprint_Filler_12,
