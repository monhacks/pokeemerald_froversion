const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BUCCANILE, gMonFrontPic_Buccanile),
    SPECIES_SPRITE(BUCCANITE, gMonFrontPic_Buccanite),
    SPECIES_SPRITE(BUCCAFEAR, gMonFrontPic_Buccafear),
    SPECIES_SPRITE(KOPIRAR, gMonFrontPic_Kopirar),
    SPECIES_SPRITE(KOPISPAR, gMonFrontPic_Kopispar),
    SPECIES_SPRITE(KOPIROAR, gMonFrontPic_Kopiroar),
    SPECIES_SPRITE(WALLITE, gMonFrontPic_Wallite),
    SPECIES_SPRITE(WALLOCK, gMonFrontPic_Wallock),
    SPECIES_SPRITE(WARSOCK, gMonFrontPic_Warsock),
    SPECIES_SPRITE(KICWINDO, gMonFrontPic_Kicwindo),
    SPECIES_SPRITE(HAUSODOOM, gMonFrontPic_Hausodoom),
    SPECIES_SPRITE(DROPYCE, gMonFrontPic_Dropyce),
    SPECIES_SPRITE(METAROURA, gMonFrontPic_Metaroura),
    SPECIES_SPRITE(CHERNABOG, gMonFrontPic_Chernabog),
    SPECIES_SPRITE(CARLILE, gMonFrontPic_Carlile),
