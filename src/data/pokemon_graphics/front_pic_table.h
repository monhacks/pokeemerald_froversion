const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(ROCK_CACTUS_STAGE_1, gMonFrontPic_Rock_Cactus_Stage_1),
    SPECIES_SPRITE(ROCK_CACTUS_STAGE_2, gMonFrontPic_Rock_Cactus_Stage_2),
    SPECIES_SPRITE(CRACKTUSS, gMonFrontPic_Cracktuss),
    SPECIES_SPRITE(DRACASTER, gMonFrontPic_Dracaster),
    SPECIES_SPRITE(BLUE EYES, gMonFrontPic_Blue Eyes),
    SPECIES_SPRITE(FILLER_1, gMonFrontPic_Filler_1),
    SPECIES_SPRITE(FILLER_2, gMonFrontPic_Filler_2),
    SPECIES_SPRITE(FILLER_3, gMonFrontPic_Filler_3),
    SPECIES_SPRITE(FILLER_4, gMonFrontPic_Filler_4),
    SPECIES_SPRITE(FILLER_5, gMonFrontPic_Filler_5),
    SPECIES_SPRITE(FILLER_6, gMonFrontPic_Filler_6),
    SPECIES_SPRITE(FILLER_7, gMonFrontPic_Filler_7),
    SPECIES_SPRITE(FILLER_8, gMonFrontPic_Filler_8),
    SPECIES_SPRITE(FILLER_9, gMonFrontPic_Filler_9),
    SPECIES_SPRITE(FILLER_10, gMonFrontPic_Filler_10),
    SPECIES_SPRITE(FILLER_11, gMonFrontPic_Filler_11),
    SPECIES_SPRITE(FILLER_12, gMonFrontPic_Filler_12),
    SPECIES_SPRITE(FILLER_13, gMonFrontPic_Filler_13),
    SPECIES_SPRITE(FILLER_14, gMonFrontPic_Filler_14),
    SPECIES_SPRITE(FILLER_15, gMonFrontPic_Filler_15),
    SPECIES_SPRITE(FILLER_16, gMonFrontPic_Filler_16),
    ...
    SPECIES_SPRITE(FILLER_37, gMonFrontPic_Filler_37),
    SPECIES_SPRITE(FILLER_38, gMonFrontPic_Filler_38),
    SPECIES_SPRITE(FILLER_39, gMonFrontPic_Filler_39),
    SPECIES_SPRITE(FILLER_40, gMonFrontPic_Filler_40),
    SPECIES_SPRITE(FILLER_41, gMonFrontPic_Filler_41),
    SPECIES_SPRITE(FILLER_42, gMonFrontPic_Filler_42),
