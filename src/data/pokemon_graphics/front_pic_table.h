const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    ///FROVERSION FAKEMON///
    ///////////////////////
    SPECIES_SPRITE(RASCALOOT, gMonFrontPic_Rascaloot),
    SPECIES_SPRITE(BANDITHUG, gMonFrontPic_Bandithug),
    SPECIES_SPRITE(RUTHLASH, gMonFrontPic_Ruthlash),
    SPECIES_SPRITE(FLOBRA, gMonFrontPic_Flobra),
    SPECIES_SPRITE(MORPHLO, gMonFrontPic_Morphlo),
    SPECIES_SPRITE(MECHOBRA, gMonFrontPic_Mechobra),
    SPECIES_SPRITE(EMBORYPS, gMonFrontPic_Emboryps),
    SPECIES_SPRITE(HUNTORYPS, gMonFrontPic_Huntoryps),
    SPECIES_SPRITE(RIPTORYPS, gMonFrontPic_Riptoryps),
    SPECIES_SPRITE(SPIRITOMB, gMonFrontPic_Spiritomb),
    SPECIES_SPRITE(SNOUMESE, gMonFrontPic_Snoumese),
    SPECIES_SPRITE(SNOUBAUL, gMonFrontPic_Snoubaul),
    SPECIES_SPRITE(NEVAWOK, gMonFrontPic_Nevawok),
    SPECIES_SPRITE(WOKAGIN, gMonFrontPic_Wokagin),
    SPECIES_SPRITE(VAYPING, gMonFrontPic_Vayping),
    SPECIES_SPRITE(KABOWL, gMonFrontPic_Kabowl),
    SPECIES_SPRITE(BOWLAST, gMonFrontPic_Bowlast),
    SPECIES_SPRITE(PHOKAI, gMonFrontPic_Phokai),
    SPECIES_SPRITE(PHOTASM, gMonFrontPic_Photasm),
    SPECIES_SPRITE(PHOTOGEIST, gMonFrontPic_Photogeist),
    SPECIES_SPRITE(TOGEKISS, gMonFrontPic_Togekiss),
    SPECIES_SPRITE(OTDORBLE, gMonFrontPic_Otdorble),
    SPECIES_SPRITE(LUTRADOR, gMonFrontPic_Lutrador),
    SPECIES_SPRITE(DUMBELLION, gMonFrontPic_Dumbellion),
    SPECIES_SPRITE(BARBELLION, gMonFrontPic_Barbellion),
    SPECIES_SPRITE(OCTIRE, gMonFrontPic_Octire),
    SPECIES_SPRITE(INVERTEBRAKE, gMonFrontPic_Invertebrake),
    SPECIES_SPRITE(HAAGLET, gMonFrontPic_Haaglet),
    SPECIES_SPRITE(WARTHAAG, gMonFrontPic_Warthaag),
    SPECIES_SPRITE(TAQUITTLE, gMonFrontPic_Taquittle),
    SPECIES_SPRITE(ESCARATACO, gMonFrontPic_Escarataco),
    SPECIES_SPRITE(CHAD_BUG_1, gMonFrontPic_Chad_Bug_1),
    SPECIES_SPRITE(CHAD_BUG_2, gMonFrontPic_Chad_Bug_2),
    SPECIES_SPRITE(PILOPOO, gMonFrontPic_Pilopoo),
    SPECIES_SPRITE(BILLFALO, gMonFrontPic_Billfalo),
    SPECIES_SPRITE(SABLIZZARD, gMonFrontPic_Sablizzard),
    SPECIES_SPRITE(PASSIMIAN, gMonFrontPic_Passimian),
    SPECIES_SPRITE(CACTAR, gMonFrontPic_Cactar),
    SPECIES_SPRITE(CRACTHORN, gMonFrontPic_Cracthorn),
    SPECIES_SPRITE(CRACKTUSS, gMonFrontPic_Cracktuss),
    SPECIES_SPRITE(DRACASTER, gMonFrontPic_Dracaster),
    SPECIES_SPRITE(BLUE_EYES, gMonFrontPic_Blue_Eyes),
    SPECIES_SPRITE(REDEYES, gMonFrontPic_Filler_1),
    SPECIES_SPRITE(MAROWAK_ALOLAN, gMonFrontPic_Marowak_Alolan),
    SPECIES_SPRITE(CONTRARAM, gMonFrontPic_Contraram),
    SPECIES_SPRITE(PLASMUNG, gMonFrontPic_Plasmung),
    SPECIES_SPRITE(GRUNTAZE, gMonFrontPic_Gruntaze),
    SPECIES_SPRITE(ELITETRIC, gMonFrontPic_Elitetric),
    SPECIES_SPRITE(MEGA_DEWGONG, gMonFrontPic_Mega_Dewgong),
    SPECIES_SPRITE(FILLER_8, gMonFrontPic_Filler_8),
    SPECIES_SPRITE(FILLER_9, gMonFrontPic_Filler_9),
    SPECIES_SPRITE(FRENTOAD, gMonFrontPic_Frentoad),
    SPECIES_SPRITE(RABATOAST, gMonFrontPic_Rabatoast),
    SPECIES_SPRITE(SHADOW_CHARIZARD, gMonFrontPic_Shadow_Charizard),
    SPECIES_SPRITE(ABYSSALDRAGONTHIRDEVO, gMonFrontPic_Abyssaldragonthirdevo),
    SPECIES_SPRITE(ABYSSALDRAGONSECONDEVO, gMonFrontPic_Abyssaldragonsecondevo),
    SPECIES_SPRITE(ABYSSALDRAGONFIRSTEVO, gMonFrontPic_Abyssaldragonfirstevo),
    SPECIES_SPRITE(CHEETO, gMonFrontPic_Cheeto),
    SPECIES_SPRITE(FILLER_17, gMonFrontPic_Filler_17),
    SPECIES_SPRITE(FILLER_18, gMonFrontPic_Filler_18),
    SPECIES_SPRITE(FILLER_19, gMonFrontPic_Filler_19),
    SPECIES_SPRITE(FILLER_20, gMonFrontPic_Filler_20),
    SPECIES_SPRITE(FILLER_21, gMonFrontPic_Filler_21),
    SPECIES_SPRITE(FILLER_22, gMonFrontPic_Filler_22),
    SPECIES_SPRITE(FILLER_23, gMonFrontPic_Filler_23),
    SPECIES_SPRITE(FILLER_24, gMonFrontPic_Filler_24),
    SPECIES_SPRITE(FILLER_25, gMonFrontPic_Filler_25),
    SPECIES_SPRITE(FILLER_26, gMonFrontPic_Filler_26),
    SPECIES_SPRITE(FILLER_27, gMonFrontPic_Filler_27),
    SPECIES_SPRITE(FILLER_28, gMonFrontPic_Filler_28),
    SPECIES_SPRITE(FILLER_29, gMonFrontPic_Filler_29),
    SPECIES_SPRITE(FILLER_30, gMonFrontPic_Filler_30),
    SPECIES_SPRITE(FILLER_31, gMonFrontPic_Filler_31),
    SPECIES_SPRITE(FILLER_32, gMonFrontPic_Filler_32),
    SPECIES_SPRITE(FILLER_33, gMonFrontPic_Filler_33),
    SPECIES_SPRITE(FILLER_34, gMonFrontPic_Filler_34),
    SPECIES_SPRITE(FILLER_35, gMonFrontPic_Filler_35),
    SPECIES_SPRITE(FILLER_36, gMonFrontPic_Filler_36),
    SPECIES_SPRITE(ARIADOS_GHOST, gMonFrontPic_Ariados_Ghost),
    SPECIES_SPRITE(FILLER_38, gMonFrontPic_Filler_38),
    SPECIES_SPRITE(CHARIZARD_X, gMonFrontPic_Charizard_X),
    SPECIES_SPRITE(WARKLOCK, gMonFrontPic_Warklock),
    ...
    SPECIES_SPRITE(METAGROSS_STEEL, gMonFrontPic_Metagross_Steel),
