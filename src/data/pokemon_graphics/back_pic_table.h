const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(UNOWN_QMARK, gMonBackPic_UnownQuestionMark),
     //Froversion Fakemon
    SPECIES_SPRITE(RASCALOOT, gMonBackPic_Rascaloot),
    SPECIES_SPRITE(BANDITHUG, gMonBackPic_Bandithug),
    SPECIES_SPRITE(RUTHLASH, gMonBackPic_Ruthlash),
    SPECIES_SPRITE(FLOBRA, gMonBackPic_Flobra),
    SPECIES_SPRITE(MORPHLO, gMonBackPic_Morphlo),
    SPECIES_SPRITE(MECHOBRA, gMonBackPic_Mechobra),
    SPECIES_SPRITE(EMBORYPS, gMonBackPic_Emboryps),
    SPECIES_SPRITE(HUNTORYPS, gMonBackPic_Huntoryps),
    SPECIES_SPRITE(RIPTORYPS, gMonBackPic_Riptoryps),
    SPECIES_SPRITE(SPIRITOMB, gMonBackPic_Spiritomb),
    SPECIES_SPRITE(SNOUMESE, gMonBackPic_Snoumese),
    SPECIES_SPRITE(SNOUBAUL, gMonBackPic_Snoubaul),
    SPECIES_SPRITE(NEVAWOK, gMonBackPic_Nevawok),
    SPECIES_SPRITE(WOKAGIN, gMonBackPic_Wokagin),
    SPECIES_SPRITE(VAYPING, gMonBackPic_Vayping),
    SPECIES_SPRITE(KABOWL, gMonBackPic_Kabowl),
    SPECIES_SPRITE(BOWLAST, gMonBackPic_Bowlast),
    SPECIES_SPRITE(PHOKAI, gMonBackPic_Phokai),
    SPECIES_SPRITE(PHOTASM, gMonBackPic_Photasm),
    SPECIES_SPRITE(PHOTOGEIST, gMonBackPic_Photogeist),
    SPECIES_SPRITE(TOGEKISS, gMonBackPic_Togekiss),
    SPECIES_SPRITE(OTDORBLE, gMonBackPic_Otdorble),
    SPECIES_SPRITE(LUTRADOR, gMonBackPic_Lutrador),
    SPECIES_SPRITE(DUMBELLION, gMonBackPic_Dumbellion),
    SPECIES_SPRITE(BARBELLION, gMonBackPic_Barbellion),
    SPECIES_SPRITE(OCTIRE, gMonBackPic_Octire),
    SPECIES_SPRITE(INVERTEBRAKE, gMonBackPic_Invertebrake),
    SPECIES_SPRITE(HAAGLET, gMonBackPic_Haaglet),
    SPECIES_SPRITE(WARTHAAG, gMonBackPic_Warthaag),
    SPECIES_SPRITE(TAQUITTLE, gMonBackPic_Taquittle),
    SPECIES_SPRITE(ESCARATACO, gMonBackPic_Escarataco),
    SPECIES_SPRITE(CHAD_BUG_1, gMonBackPic_Chad_Bug_1),
    SPECIES_SPRITE(CHAD_BUG_2, gMonBackPic_Chad_Bug_2),
    SPECIES_SPRITE(PILOPOO, gMonBackPic_Pilopoo),
    SPECIES_SPRITE(BILLFALO, gMonBackPic_Billfalo),
    SPECIES_SPRITE(SABLIZZARD, gMonBackPic_Sablizzard),
    SPECIES_SPRITE(PASSIMIAN, gMonBackPic_Passimian),
    SPECIES_SPRITE(CACTAR, gMonBackPic_Cactar),
    SPECIES_SPRITE(CRACTHORN, gMonBackPic_Cracthorn),
    SPECIES_SPRITE(CRACKTUSS, gMonBackPic_Cracktuss),
    SPECIES_SPRITE(DRACASTER, gMonBackPic_Dracaster),
    SPECIES_SPRITE(BLUE_EYES, gMonBackPic_Blue_Eyes),
    SPECIES_SPRITE(REDEYES, gMonBackPic_Filler_1),
    SPECIES_SPRITE(MAROWAK_ALOLAN, gMonBackPic_Marowak_Alolan),
    SPECIES_SPRITE(CONTRARAM, gMonBackPic_Contraram),
    SPECIES_SPRITE(PLASMUNG, gMonBackPic_Plasmung),
    SPECIES_SPRITE(GRUNTAZE, gMonBackPic_Gruntaze),
    SPECIES_SPRITE(ELITETRIC, gMonBackPic_Elitetric),
    SPECIES_SPRITE(MEGA_DEWGONG, gMonBackPic_Mega_Dewgong),
    SPECIES_SPRITE(FILLER_8, gMonBackPic_Filler_8),
    SPECIES_SPRITE(FILLER_9, gMonBackPic_Filler_9),
    SPECIES_SPRITE(FRENTOAD, gMonBackPic_Frentoad),
    SPECIES_SPRITE(RABATOAST, gMonBackPic_Rabatoast),
    SPECIES_SPRITE(SHADOW_CHARIZARD, gMonBackPic_Shadow_Charizard),
    SPECIES_SPRITE(ABYSSALDRAGONTHIRDEVO, gMonBackPic_Abyssaldragonthirdevo),
    SPECIES_SPRITE(ABYSSALDRAGONSECONDEVO, gMonBackPic_Abyssaldragonsecondevo),
    SPECIES_SPRITE(ABYSSALDRAGONFIRSTEVO, gMonBackPic_Abyssaldragonfirstevo),
    SPECIES_SPRITE(CHEETO, gMonBackPic_Cheeto),
    SPECIES_SPRITE(FILLER_17, gMonBackPic_Filler_17),
    SPECIES_SPRITE(FILLER_18, gMonBackPic_Filler_18),
    SPECIES_SPRITE(FILLER_19, gMonBackPic_Filler_19),
    SPECIES_SPRITE(FILLER_20, gMonBackPic_Filler_20),
    SPECIES_SPRITE(FILLER_21, gMonBackPic_Filler_21),
    SPECIES_SPRITE(FILLER_22, gMonBackPic_Filler_22),
    SPECIES_SPRITE(FILLER_23, gMonBackPic_Filler_23),
    SPECIES_SPRITE(FILLER_24, gMonBackPic_Filler_24),
    SPECIES_SPRITE(FILLER_25, gMonBackPic_Filler_25),
    SPECIES_SPRITE(FILLER_26, gMonBackPic_Filler_26),
    SPECIES_SPRITE(FILLER_27, gMonBackPic_Filler_27),
    SPECIES_SPRITE(FILLER_28, gMonBackPic_Filler_28),
    SPECIES_SPRITE(FILLER_29, gMonBackPic_Filler_29),
    SPECIES_SPRITE(FILLER_30, gMonBackPic_Filler_30),
    SPECIES_SPRITE(FILLER_31, gMonBackPic_Filler_31),
    SPECIES_SPRITE(FILLER_32, gMonBackPic_Filler_32),
    SPECIES_SPRITE(FILLER_33, gMonBackPic_Filler_33),
    SPECIES_SPRITE(FILLER_34, gMonBackPic_Filler_34),
    SPECIES_SPRITE(FILLER_35, gMonBackPic_Filler_35),
    SPECIES_SPRITE(FILLER_36, gMonBackPic_Filler_36),
    SPECIES_SPRITE(ARIADOS_GHOST, gMonBackPic_Ariados_Ghost),
    SPECIES_SPRITE(FILLER_38, gMonBackPic_Filler_38),
    SPECIES_SPRITE(CHARIZARD_X, gMonBackPic_Charizard_X),
    SPECIES_SPRITE(WARKLOCK, gMonBackPic_Warklock),
    SPECIES_SPRITE(CLOCLOCK, gMonBackPic_Cloclock),
    SPECIES_SPRITE(SPIRETT, gMonBackPic_Spirett),
};
