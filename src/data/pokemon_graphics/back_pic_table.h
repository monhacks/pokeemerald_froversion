const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BUCCANILE, gMonBackPic_Buccanile),
    SPECIES_SPRITE(BUCCANITE, gMonBackPic_Buccanite),
    SPECIES_SPRITE(BUCCAFEAR, gMonBackPic_Buccafear),
    SPECIES_SPRITE(KOPIRAR, gMonBackPic_Kopirar),
    SPECIES_SPRITE(KOPISPAR, gMonBackPic_Kopispar),
    SPECIES_SPRITE(KOPIROAR, gMonBackPic_Kopiroar),
    SPECIES_SPRITE(WALLITE, gMonBackPic_Wallite),
    SPECIES_SPRITE(WALLOCK, gMonBackPic_Wallock),
    SPECIES_SPRITE(WARSOCK, gMonBackPic_Warsock),
    SPECIES_SPRITE(KICWINDO, gMonBackPic_Kicwindo),
    SPECIES_SPRITE(HAUSODOOM, gMonBackPic_Hausodoom),
    SPECIES_SPRITE(DROPYCE, gMonBackPic_Dropyce),
    SPECIES_SPRITE(METAROURA, gMonBackPic_Metaroura),
    SPECIES_SPRITE(CHERNABOG, gMonBackPic_Chernabog),
    SPECIES_SPRITE(CARLILE, gMonBackPic_Carlile),
