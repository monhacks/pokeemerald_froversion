const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(ROCK_CACTUS_STAGE_1, gMonBackPic_Rock_Cactus_Stage_1),
    SPECIES_SPRITE(ROCK_CACTUS_STAGE_2, gMonBackPic_Rock_Cactus_Stage_2),
    ...
    SPECIES_SPRITE(FILLER_1, gMonBackPic_Filler_1),
    SPECIES_SPRITE(FILLER_2, gMonBackPic_Filler_2),
    SPECIES_SPRITE(FILLER_3, gMonBackPic_Filler_3),
    SPECIES_SPRITE(FILLER_4, gMonBackPic_Filler_4),
    SPECIES_SPRITE(FILLER_5, gMonBackPic_Filler_5),
    SPECIES_SPRITE(FILLER_6, gMonBackPic_Filler_6),
    SPECIES_SPRITE(FILLER_7, gMonBackPic_Filler_7),
    SPECIES_SPRITE(FILLER_8, gMonBackPic_Filler_8),
    SPECIES_SPRITE(FILLER_9, gMonBackPic_Filler_9),
    SPECIES_SPRITE(FILLER_10, gMonBackPic_Filler_10),
    SPECIES_SPRITE(FILLER_11, gMonBackPic_Filler_11),
    SPECIES_SPRITE(FILLER_12, gMonBackPic_Filler_12),
    SPECIES_SPRITE(FILLER_13, gMonBackPic_Filler_13),
    SPECIES_SPRITE(FILLER_14, gMonBackPic_Filler_14),
    SPECIES_SPRITE(FILLER_15, gMonBackPic_Filler_15),
    ...
    SPECIES_SPRITE(FILLER_39, gMonBackPic_Filler_39),
    SPECIES_SPRITE(FILLER_40, gMonBackPic_Filler_40),
    SPECIES_SPRITE(FILLER_41, gMonBackPic_Filler_41),
    SPECIES_SPRITE(FILLER_42, gMonBackPic_Filler_42),
};
