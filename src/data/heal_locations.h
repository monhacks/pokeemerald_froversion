static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NIAGARA_VILLAGE - 1] = {MAP_GROUP(NIAGARA_VILLAGE), MAP_NUM(NIAGARA_VILLAGE), 0, 0},
    ...
    [HEAL_LOCATION_HUB_ROOM - 1] = {MAP_GROUP(HUB_ROOM), MAP_NUM(HUB_ROOM), 35, 11},
};
