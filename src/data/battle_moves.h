const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    {
        .effect = EFFECT_ELEMENTAL_BREATH,
        .power = 33,
        .type = TYPE_MYSTERY,
        .accuracy = 100,
        .pp = 10,
