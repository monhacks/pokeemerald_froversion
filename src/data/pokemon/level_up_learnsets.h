...
static const struct LevelUpMove sAriados_GhostLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sCharizard_XLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 1, MOVE_TACKLE),
	LEVEL_UP_END
};
static const struct LevelUpMove sWarklockLevelUpLearnset[] = {
