...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_CLASS_TEAM_MAGA,
    ...
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_CLASS_TEAM_MAGA,
    ...
    [FACILITY_CLASS_AQUA_LEADER_ARCHIE] = TRAINER_CLASS_MAGA_LEADER,
    ...
    [FACILITY_CLASS_MAGMA_LEADER_MAXIE] = TRAINER_CLASS_ANTIFA_LEADER,
