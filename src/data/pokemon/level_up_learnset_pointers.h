const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_BUCCANILE] = sBuccanileLevelUpLearnset,
    [SPECIES_BUCCANITE] = sBuccaniteLevelUpLearnset,
    [SPECIES_BUCCAFEAR] = sBuccafearLevelUpLearnset,
    [SPECIES_KOPIRAR] = sKopirarLevelUpLearnset,
    [SPECIES_KOPISPAR] = sKopisparLevelUpLearnset,
    [SPECIES_KOPIROAR] = sKopiroarLevelUpLearnset,
    [SPECIES_WALLITE] = sWalliteLevelUpLearnset,
    [SPECIES_WALLOCK] = sWallockLevelUpLearnset,
    [SPECIES_WARSOCK] = sWarsockLevelUpLearnset,
    [SPECIES_KICWINDO] = sKicwindoLevelUpLearnset,
    [SPECIES_HAUSODOOM] = sHausodoomLevelUpLearnset,
    [SPECIES_DROPYCE] = sDropyceLevelUpLearnset,
    [SPECIES_METAROURA] = sMetarouraLevelUpLearnset,
    [SPECIES_CHERNABOG] = sChernabogLevelUpLearnset,
    [SPECIES_CARLILE] = sCarlileLevelUpLearnset,
