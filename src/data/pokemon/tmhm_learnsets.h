...
const u32 gTMHMLearnsets[][2] =
{
    ...
    [SPECIES_CONTRARAM]    = TMHM_LEARNSET(TMHM(TM05_ROAR)
                                        ...
                                        | TMHM(HM01_CUT)
                                        | TMHM(HM04_STRENGTH)),
    [SPECIES_PLASMUNG]    = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM02_DRAGON_CLAW)
                                        | TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM05_ROAR)
                                        ...
                                        | TMHM(HM07_WATERFALL)
                                        | TMHM(HM08_DIVE)),
    [SPECIES_GRUNTAZE]    = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM02_DRAGON_CLAW)
                                        | TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM05_ROAR)
                                        ...
                                        | TMHM(HM07_WATERFALL)
                                        | TMHM(HM08_DIVE)),
    [SPECIES_ELITETRIC]    = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM02_DRAGON_CLAW)
                                        | TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM05_ROAR)
