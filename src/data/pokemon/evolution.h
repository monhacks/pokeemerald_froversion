const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CLEFABLE]   = {{EVO_ITEM, ITEM_SMOKE_BALL, SPECIES_GENGAR}},
    ...
    [SPECIES_ABRA]       = {{EVO_LEVEL, 28, SPECIES_KADABRA}},
    ...
    [SPECIES_ONIX]       = {{EVO_MOVE, MOVE_IRON_TAIL, SPECIES_STEELIX}},
    ...
    [SPECIES_MAROWAK]     = {{EVO_ITEM, ITEM_SMOKE_BALL, SPECIES_MAROWAK_ALOLAN}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_MOVE, MOVE_STEEL_WING, SPECIES_SCIZOR}},
    ...
    [SPECIES_FURRET ]    = {{EVO_LEVEL, 101, SPECIES_SPIRETT}},
    ...
    [SPECIES_ARIADOS]    = {{EVO_ITEM, ITEM_SMOKE_BALL, SPECIES_ARIADOS_GHOST}},   
    ...
    [SPECIES_TOGEPI]     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_TOGEKISS}},
    ...
    //froversion fakemon//
    [SPECIES_RASCALOOT]  = {{EVO_LEVEL, 16, SPECIES_BANDITHUG}},
    [SPECIES_BANDITHUG]  = {{EVO_LEVEL, 36, SPECIES_RUTHLASH}},
    [SPECIES_FLOBRA]     = {{EVO_LEVEL, 16, SPECIES_MORPHLO}},
    [SPECIES_MORPHLO]    = {{EVO_LEVEL, 36, SPECIES_MECHOBRA}},
    [SPECIES_EMBORYPS]   = {{EVO_LEVEL, 16, SPECIES_HUNTORYPS}},
    [SPECIES_HUNTORYPS]  = {{EVO_LEVEL, 36, SPECIES_RIPTORYPS}},
    [SPECIES_CACTAR]     = {{EVO_LEVEL, 14, SPECIES_CRACTHORN}},
    [SPECIES_CRACTHORN] =  {{EVO_LEVEL, 25, SPECIES_CRACKTUSS}},
    [SPECIES_DUMBELLION] = {{EVO_LEVEL, 34, SPECIES_BARBELLION}},
    [SPECIES_KABOWL] =      {{EVO_LEVEL, 20, SPECIES_BOWLAST}},
    [SPECIES_NEVAWOK] =     {{EVO_LEVEL, 38, SPECIES_WOKAGIN}},
    [SPECIES_SNOUMESE] =    {{EVO_LEVEL, 26, SPECIES_SNOUBAUL}},
    [SPECIES_PHOKAI] =      {{EVO_LEVEL, 28, SPECIES_PHOTASM}},
    [SPECIES_PHOTASM] =     {{EVO_LEVEL, 45, SPECIES_PHOTOGEIST}},
    [SPECIES_OCTIRE] =      {{EVO_MOVE, MOVE_IRON_HEAD, SPECIES_INVERTEBRAKE}},
    [SPECIES_HAAGLET] =     {{EVO_LEVEL, 22, SPECIES_WARTHAAG}},
    [SPECIES_TAQUITTLE] =   {{EVO_LEVEL, 18, SPECIES_ESCARATACO}},
    [SPECIES_FRENTOAD]    = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_RABATOAST}},
    [SPECIES_OTDORBLE]    = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_LUTRADOR}},
    [SPECIES_CHAD_BUG_1]  = {{EVO_LEVEL, 28, SPECIES_CHAD_BUG_2}},
    [SPECIES_PLASMUNG]    = {{EVO_LEVEL, 26, SPECIES_GRUNTAZE}},
    [SPECIES_GRUNTAZE]    = {{EVO_LEVEL, 52, SPECIES_ELITETRIC}},
    [SPECIES_CLOCLOCK]    = {{EVO_LEVEL, 40, SPECIES_WARKLOCK}},
    [SPECIES_ABYSSALDRAGONFIRSTEVO]    = {{EVO_LEVEL, 40, SPECIES_ABYSSALDRAGONSECONDEVO}},
    [SPECIES_ABYSSALDRAGONSECONDEVO]    = {{EVO_LEVEL, 40, SPECIES_ABYSSALDRAGONTHIRDEVO}},
};