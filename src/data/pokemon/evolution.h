const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_WALLITE] =   {{EVO_LEVEL, 16, SPECIES_WALLOCK}},
    [SPECIES_WALLOCK] =   {{EVO_LEVEL, 36, SPECIES_WARSOCK}},
    [SPECIES_KOPIRAR] =   {{EVO_LEVEL, 16, SPECIES_KOPISPAR}},
    [SPECIES_KOPISPAR] =   {{EVO_LEVEL, 36, SPECIES_KOPIROAR}},
    [SPECIES_BUCCANILE] =   {{EVO_LEVEL, 16, SPECIES_BUCCANITE}},
    [SPECIES_BUCCANITE] =   {{EVO_LEVEL, 36, SPECIES_BUCCAFEAR}},
    [SPECIES_DROPYCE] =     {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_METAROURA}},
    [SPECIES_KICWINDO] =    {{EVO_ITEM, ITEM_ASSAULT_VEST, SPECIES_METAROURA}},
