...
const u32 gItemIcon_ColangeloGears[] = INCBIN_U32("graphics/items/icons/colangelo_gears.4bpp.lz");
const u32 gItemIconPalette_ColangeloGears[] = INCBIN_U32("graphics/items/icon_palettes/colangelo_gears.gbapal.lz");
