...
const struct SpritePalette gSpritePalette_CinnibarIslandGrass = {gFieldEffectObjectPaletteCinnabarIslandGrass, FLDEFF_PAL_TAG_CINNABAR_ISLAND_GRASS};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_TallGrass = {
    .tileTag = 0xFFFF,
    .paletteTag = FLDEFF_PAL_TAG_CINNABAR_ISLAND_GRASS,
