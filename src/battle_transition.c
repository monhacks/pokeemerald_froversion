...
static const u16 sTeamMaga_Palette[] = INCBIN_U16("graphics/battle_transitions/team_maga.gbapal");
...
static const u8 sMugshotsTrainerPicIDsTable[MUGSHOTS_COUNT] =
{
    ...
    [MUGSHOT_SIDNEY] = TRAINER_PIC_OFFICE_PAM,
    [MUGSHOT_PHOEBE] = TRAINER_PIC_OFFICE_DWIGHT,
    [MUGSHOT_GLACIA] = TRAINER_PIC_OFFICE_JIM,
    [MUGSHOT_DRAKE] = TRAINER_PIC_OFFICE_MICHAEL,
...
static bool8 Phase2_Aqua_Func1(struct Task *task)
{
    ...
    LoadPalette(sTeamMaga_Palette, 0xF0, 0x20);
