...
const u16 gSpeciesToHoennPokedexNum[] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(BUCCANILE),
    SPECIES_TO_HOENN(BUCCANITE),
    SPECIES_TO_HOENN(BUCCAFEAR),
    SPECIES_TO_HOENN(KOPIRAR),
    SPECIES_TO_HOENN(KOPISPAR),
    SPECIES_TO_HOENN(KOPIROAR),
    SPECIES_TO_HOENN(WALLITE),
    SPECIES_TO_HOENN(WALLOCK),
    SPECIES_TO_HOENN(WARSOCK),
    SPECIES_TO_HOENN(KICWINDO),
    SPECIES_TO_HOENN(HAUSODOOM),
    SPECIES_TO_HOENN(DROPYCE),
    SPECIES_TO_HOENN(METAROURA),
    SPECIES_TO_HOENN(CHERNABOG),
    SPECIES_TO_HOENN(CARLILE),
...
const u16 gSpeciesToNationalPokedexNum[] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(BUCCANILE),
    SPECIES_TO_NATIONAL(BUCCANITE),
    SPECIES_TO_NATIONAL(BUCCAFEAR),
    SPECIES_TO_NATIONAL(KOPIRAR),
    SPECIES_TO_NATIONAL(KOPISPAR),
    SPECIES_TO_NATIONAL(KOPIROAR),
    SPECIES_TO_NATIONAL(WALLITE),
    SPECIES_TO_NATIONAL(WALLOCK),
    SPECIES_TO_NATIONAL(WARSOCK),
    SPECIES_TO_NATIONAL(KICWINDO),
    SPECIES_TO_NATIONAL(HAUSODOOM),
    SPECIES_TO_NATIONAL(DROPYCE),
    SPECIES_TO_NATIONAL(METAROURA),
    SPECIES_TO_NATIONAL(CHERNABOG),
    SPECIES_TO_NATIONAL(CARLILE),
...
HOENN_TO_NATIONAL(BUCCANILE),
HOENN_TO_NATIONAL(BUCCANITE),
HOENN_TO_NATIONAL(BUCCAFEAR),
HOENN_TO_NATIONAL(KOPIRAR),
HOENN_TO_NATIONAL(KOPISPAR),
HOENN_TO_NATIONAL(KOPIROAR),
HOENN_TO_NATIONAL(WALLITE),
HOENN_TO_NATIONAL(WALLOCK),
HOENN_TO_NATIONAL(WARSOCK),
HOENN_TO_NATIONAL(KICWINDO),
HOENN_TO_NATIONAL(HAUSODOOM),
HOENN_TO_NATIONAL(DROPYCE),
HOENN_TO_NATIONAL(METAROURA),
HOENN_TO_NATIONAL(CHERNABOG),
HOENN_TO_NATIONAL(CARLILE),
...
[SPECIES_BUCCANILE - 1] = 0x09,
[SPECIES_BUCCANITE - 1] = 0x09,
[SPECIES_BUCCAFEAR - 1] = 0x09,
[SPECIES_KOPIRAR - 1] = 0x09,
[SPECIES_KOPISPAR - 1] = 0x09,
[SPECIES_KOPIROAR - 1] = 0x09,
[SPECIES_WALLITE - 1] = 0x09,
[SPECIES_WALLOCK - 1] = 0x09,
[SPECIES_WARSOCK - 1] = 0x09,
[SPECIES_KICWINDO - 1] = 0x09,
[SPECIES_HAUSODOOM - 1] = 0x09,
[SPECIES_DROPYCE - 1] = 0x09,
[SPECIES_METAROURA - 1] = 0x09,
[SPECIES_CHERNABOG - 1] = 0x09,
[SPECIES_CARLILE - 1] = 0x09,
