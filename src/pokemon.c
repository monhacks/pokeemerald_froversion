...
const u16 gSpeciesToHoennPokedexNum[] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(PLASMUNG),
    SPECIES_TO_HOENN(GRUNTAZE),
    SPECIES_TO_HOENN(ELITETRIC),
    SPECIES_TO_HOENN(MEGA_DEWGONG),
    SPECIES_TO_HOENN(FILLER_8),
    SPECIES_TO_HOENN(FILLER_9),
    SPECIES_TO_HOENN(FRENTOAD),
    SPECIES_TO_HOENN(RABATOAST),
    SPECIES_TO_HOENN(SHADOW_CHARIZARD),
    SPECIES_TO_HOENN(ABYSSALDRAGONTHIRDEVO),
    SPECIES_TO_HOENN(ABYSSALDRAGONSECONDEVO),
    SPECIES_TO_HOENN(ABYSSALDRAGONFIRSTEVO),
    SPECIES_TO_HOENN(CHEETO),
    ...
    SPECIES_TO_HOENN(ARIADOS_GHOST),
    SPECIES_TO_HOENN(FILLER_38),
    SPECIES_TO_HOENN(CHARIZARD_X),
    SPECIES_TO_HOENN(WARKLOCK),
    SPECIES_TO_HOENN(CLOCLOCK),
    SPECIES_TO_HOENN(SPIRETT),
    SPECIES_TO_HOENN(METAGROSS_FIRE),
    SPECIES_TO_HOENN(METAGROSS_WATER),
    SPECIES_TO_HOENN(METAGROSS_GRASS),
    SPECIES_TO_HOENN(METAGROSS_ELECTRIC),
    SPECIES_TO_HOENN(METAGROSS_NORMAL),
    SPECIES_TO_HOENN(METAGROSS_ICE),
    SPECIES_TO_HOENN(METAGROSS_FIGHTING),
    SPECIES_TO_HOENN(METAGROSS_POISON),
    SPECIES_TO_HOENN(METAGROSS_GROUND),
    SPECIES_TO_HOENN(METAGROSS_FLYING),
    SPECIES_TO_HOENN(METAGROSS_BUG),
    SPECIES_TO_HOENN(METAGROSS_GHOST),
    SPECIES_TO_HOENN(METAGROSS_DRAGON),
...
const u16 gSpeciesToNationalPokedexNum[] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(PLASMUNG),
    SPECIES_TO_NATIONAL(GRUNTAZE),
    SPECIES_TO_NATIONAL(ELITETRIC),
    SPECIES_TO_NATIONAL(MEGA_DEWGONG),
    SPECIES_TO_NATIONAL(FILLER_8),
    SPECIES_TO_NATIONAL(FILLER_9),
    SPECIES_TO_NATIONAL(FRENTOAD),
    SPECIES_TO_NATIONAL(RABATOAST),
    SPECIES_TO_NATIONAL(SHADOW_CHARIZARD),
    SPECIES_TO_NATIONAL(ABYSSALDRAGONTHIRDEVO),
    SPECIES_TO_NATIONAL(ABYSSALDRAGONSECONDEVO),
    SPECIES_TO_NATIONAL(ABYSSALDRAGONFIRSTEVO),
    SPECIES_TO_NATIONAL(CHEETO),
    ...
    SPECIES_TO_NATIONAL(ARIADOS_GHOST),
    SPECIES_TO_NATIONAL(FILLER_38),
    SPECIES_TO_NATIONAL(CHARIZARD_X),
    SPECIES_TO_NATIONAL(WARKLOCK),
    SPECIES_TO_NATIONAL(CLOCLOCK),
    SPECIES_TO_NATIONAL(SPIRETT),
    SPECIES_TO_NATIONAL(METAGROSS_FIRE),
    SPECIES_TO_NATIONAL(METAGROSS_WATER),
    SPECIES_TO_NATIONAL(METAGROSS_GRASS),
    SPECIES_TO_NATIONAL(METAGROSS_ELECTRIC),
    SPECIES_TO_NATIONAL(METAGROSS_NORMAL),
    SPECIES_TO_NATIONAL(METAGROSS_ICE),
    SPECIES_TO_NATIONAL(METAGROSS_FIGHTING),
    SPECIES_TO_NATIONAL(METAGROSS_POISON),
    SPECIES_TO_NATIONAL(METAGROSS_GROUND),
    SPECIES_TO_NATIONAL(METAGROSS_FLYING),
    SPECIES_TO_NATIONAL(METAGROSS_BUG),
    SPECIES_TO_NATIONAL(METAGROSS_GHOST),
    SPECIES_TO_NATIONAL(METAGROSS_DRAGON),
...
const u16 gHoennToNationalOrder[] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(PLASMUNG),
    HOENN_TO_NATIONAL(GRUNTAZE),
    HOENN_TO_NATIONAL(ELITETRIC),
    HOENN_TO_NATIONAL(MEGA_DEWGONG),
    HOENN_TO_NATIONAL(FILLER_8),
    HOENN_TO_NATIONAL(FILLER_9),
    HOENN_TO_NATIONAL(FRENTOAD),
    HOENN_TO_NATIONAL(RABATOAST),
    HOENN_TO_NATIONAL(SHADOW_CHARIZARD),
    HOENN_TO_NATIONAL(ABYSSALDRAGONTHIRDEVO),
    HOENN_TO_NATIONAL(ABYSSALDRAGONSECONDEVO),
    HOENN_TO_NATIONAL(ABYSSALDRAGONFIRSTEVO),
    HOENN_TO_NATIONAL(CHEETO),
    ...
    HOENN_TO_NATIONAL(ARIADOS_GHOST),
    HOENN_TO_NATIONAL(FILLER_38),
    HOENN_TO_NATIONAL(CHARIZARD_X),
    HOENN_TO_NATIONAL(WARKLOCK),
    HOENN_TO_NATIONAL(CLOCLOCK),
    HOENN_TO_NATIONAL(SPIRETT),
    HOENN_TO_NATIONAL(METAGROSS_FIRE),
    HOENN_TO_NATIONAL(METAGROSS_WATER),
    HOENN_TO_NATIONAL(METAGROSS_GRASS),
    HOENN_TO_NATIONAL(METAGROSS_ELECTRIC),
    HOENN_TO_NATIONAL(METAGROSS_NORMAL),
    HOENN_TO_NATIONAL(METAGROSS_ICE),
    HOENN_TO_NATIONAL(METAGROSS_FIGHTING),
    HOENN_TO_NATIONAL(METAGROSS_POISON),
    HOENN_TO_NATIONAL(METAGROSS_GROUND),
    HOENN_TO_NATIONAL(METAGROSS_FLYING),
    HOENN_TO_NATIONAL(METAGROSS_BUG),
    HOENN_TO_NATIONAL(METAGROSS_GHOST),
    HOENN_TO_NATIONAL(METAGROSS_DRAGON),
    HOENN_TO_NATIONAL(METAGROSS_DARK),
    HOENN_TO_NATIONAL(METAGROSS_FAIRY),
    HOENN_TO_NATIONAL(METAGROSS_ROCK),
...
static const u8 sMonFrontAnimIdsTable[] =
{
    ...
    [SPECIES_PLASMUNG - 1] = 0x09,
    [SPECIES_GRUNTAZE - 1] = 0x09,
    [SPECIES_ELITETRIC - 1] = 0x09,
    [SPECIES_MEGA_DEWGONG - 1] = 0x09,
    [SPECIES_FILLER_8 - 1] = 0x09,
    [SPECIES_FILLER_9 - 1] = 0x09,
    [SPECIES_FRENTOAD - 1] = 0x09,
    [SPECIES_RABATOAST - 1] = 0x09,
    [SPECIES_SHADOW_CHARIZARD - 1] = 0x09,
    [SPECIES_ABYSSALDRAGONTHIRDEVO - 1] = 0x09,
    [SPECIES_ABYSSALDRAGONSECONDEVO - 1] = 0x09,
    [SPECIES_ABYSSALDRAGONFIRSTEVO - 1] = 0x09,
    [SPECIES_CHEETO - 1] = 0x09,
    ...
    [SPECIES_ARIADOS_GHOST - 1] = 0x09,
    [SPECIES_FILLER_38 - 1] = 0x09,
    [SPECIES_CHARIZARD_X - 1] = 0x09,
    [SPECIES_WARKLOCK - 1] = 0x09,
    [SPECIES_CLOCLOCK - 1] = 0x09,
    [SPECIES_SPIRETT - 1] = 0x09,
    [SPECIES_METAGROSS_FIRE - 1] = 0x09,
    [SPECIES_METAGROSS_WATER - 1] = 0x09,
    [SPECIES_METAGROSS_GRASS - 1] = 0x09,
    [SPECIES_METAGROSS_ELECTRIC - 1] = 0x09,
    [SPECIES_METAGROSS_NORMAL - 1] = 0x09,
    [SPECIES_METAGROSS_ICE - 1] = 0x09,
    [SPECIES_METAGROSS_FIGHTING - 1] = 0x09,
    [SPECIES_METAGROSS_POISON - 1] = 0x09,
    [SPECIES_METAGROSS_GROUND - 1] = 0x09,
    [SPECIES_METAGROSS_FLYING - 1] = 0x09,
    [SPECIES_METAGROSS_BUG - 1] = 0x09,
    [SPECIES_METAGROSS_GHOST - 1] = 0x09,
    [SPECIES_METAGROSS_DRAGON - 1] = 0x09,
...
#define CALC_TRAINER_STAT(base, iv, ev, statIndex, field)                                          \
{                                                                                                  \
    u8 baseStat = gBaseStats[species].base;                                                        \
    s32 n = (((((2 * baseStat + iv + ev / 4) * level) / 100) + 5) * difficultyModification) / 100; \
    u8 nature = GetNature(mon, TRUE);                                                              \
    n = ModifyStatByNature(nature, n, statIndex);                                                  \
    SetMonData(mon, field, &n);                                                                    \
}
...
void CalculateTrainerMonStats(struct Pokemon *mon)
{
    ...
    CALC_TRAINER_STAT(baseAttack, attackIV, attackEV, STAT_ATK, MON_DATA_ATK)
    CALC_TRAINER_STAT(baseDefense, defenseIV, defenseEV, STAT_DEF, MON_DATA_DEF)
    CALC_TRAINER_STAT(baseSpeed, speedIV, speedEV, STAT_SPEED, MON_DATA_SPEED)
    CALC_TRAINER_STAT(baseSpAttack, spAttackIV, spAttackEV, STAT_SPATK, MON_DATA_SPATK)
    CALC_TRAINER_STAT(baseSpDefense, spDefenseIV, spDefenseEV, STAT_SPDEF, MON_DATA_SPDEF)
