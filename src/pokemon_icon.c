...
const u8 *const gMonIconTable[] =
{
    ...
    //froversion fakemon
    [SPECIES_RASCALOOT] = gMonIcon_Rascaloot,
    [SPECIES_BANDITHUG] = gMonIcon_Bandithug,
    [SPECIES_RUTHLASH] = gMonIcon_Ruthlash,
    [SPECIES_FLOBRA] = gMonIcon_Flobra,
    [SPECIES_MORPHLO] = gMonIcon_Morphlo,
    [SPECIES_MECHOBRA] = gMonIcon_Mechobra,
    [SPECIES_EMBORYPS] = gMonIcon_Emboryps,
    [SPECIES_HUNTORYPS] = gMonIcon_Huntoryps,
    [SPECIES_RIPTORYPS] = gMonIcon_Riptoryps,
    [SPECIES_SPIRITOMB] = gMonIcon_Spiritomb,
    [SPECIES_SNOUMESE] = gMonIcon_Snoumese,
    [SPECIES_SNOUBAUL] = gMonIcon_Snoubaul,
    [SPECIES_NEVAWOK] = gMonIcon_Nevawok,
    [SPECIES_WOKAGIN] = gMonIcon_Wokagin,
    [SPECIES_VAYPING] = gMonIcon_Vayping,
    [SPECIES_KABOWL] = gMonIcon_Kabowl,
    [SPECIES_BOWLAST] = gMonIcon_Bowlast,
    [SPECIES_PHOKAI] = gMonIcon_Phokai,
    [SPECIES_PHOTASM] = gMonIcon_Photasm,
    [SPECIES_PHOTOGEIST] = gMonIcon_Photogeist,
    [SPECIES_TOGEKISS] = gMonIcon_Togekiss,
    [SPECIES_OTDORBLE] = gMonIcon_Otdorble,
    [SPECIES_LUTRADOR] = gMonIcon_Lutrador,
    [SPECIES_DUMBELLION] = gMonIcon_Dumbellion,
    [SPECIES_BARBELLION] = gMonIcon_Barbellion,
    [SPECIES_OCTIRE] = gMonIcon_Octire,
    [SPECIES_INVERTEBRAKE] = gMonIcon_Invertebrake,
    [SPECIES_HAAGLET] = gMonIcon_Haaglet,
    [SPECIES_WARTHAAG] = gMonIcon_Warthaag,
    [SPECIES_TAQUITTLE] = gMonIcon_Taquittle,
    [SPECIES_ESCARATACO] = gMonIcon_Escarataco,
    [SPECIES_CHAD_BUG_1] = gMonIcon_Chad_Bug_1,
    [SPECIES_CHAD_BUG_2] = gMonIcon_Chad_Bug_2,
    [SPECIES_PILOPOO] = gMonIcon_Pilopoo,
    [SPECIES_BILLFALO] = gMonIcon_Billfalo,
    [SPECIES_SABLIZZARD] = gMonIcon_Sablizzard,
    [SPECIES_PASSIMIAN] = gMonIcon_Passimian,
    [SPECIES_CACTAR] = gMonIcon_Cactar,
    [SPECIES_CRACTHORN] = gMonIcon_Cracthorn,
    [SPECIES_CRACKTUSS] = gMonIcon_Cracktuss,
    [SPECIES_DRACASTER] = gMonIcon_Dracaster,
    [SPECIES_BLUE_EYES] = gMonIcon_Blue_Eyes,
    [SPECIES_REDEYES] = gMonIcon_Filler_1,
    [SPECIES_MAROWAK_ALOLAN] = gMonIcon_Marowak_Alolan,
    [SPECIES_CONTRARAM] = gMonIcon_Contraram,
    [SPECIES_PLASMUNG] = gMonIcon_Plasmung,
    [SPECIES_GRUNTAZE] = gMonIcon_Gruntaze,
    [SPECIES_ELITETRIC] = gMonIcon_Elitetric,
    [SPECIES_MEGA_DEWGONG] = gMonIcon_Mega_Dewgong,
    [SPECIES_FILLER_8] = gMonIcon_Filler_8,
    [SPECIES_FILLER_9] = gMonIcon_Filler_9,
    [SPECIES_FRENTOAD] = gMonIcon_Frentoad,
    [SPECIES_RABATOAST] = gMonIcon_Rabatoast,
    [SPECIES_SHADOW_CHARIZARD] = gMonIcon_Shadow_Charizard,
    [SPECIES_ABYSSALDRAGONTHIRDEVO] = gMonIcon_Abyssaldragonthirdevo,
    [SPECIES_ABYSSALDRAGONSECONDEVO] = gMonIcon_Abyssaldragonsecondevo,
    [SPECIES_ABYSSALDRAGONFIRSTEVO] = gMonIcon_Abyssaldragonfirstevo,
    [SPECIES_CHEETO] = gMonIcon_Cheeto,
    [SPECIES_FILLER_17] = gMonIcon_Filler_17,
    [SPECIES_FILLER_18] = gMonIcon_Filler_18,
    [SPECIES_FILLER_19] = gMonIcon_Filler_19,
    [SPECIES_FILLER_20] = gMonIcon_Filler_20,
    [SPECIES_FILLER_21] = gMonIcon_Filler_21,
    [SPECIES_FILLER_22] = gMonIcon_Filler_22,
    [SPECIES_FILLER_23] = gMonIcon_Filler_23,
    [SPECIES_FILLER_24] = gMonIcon_Filler_24,
    [SPECIES_FILLER_25] = gMonIcon_Filler_25,
    [SPECIES_FILLER_26] = gMonIcon_Filler_26,
    [SPECIES_FILLER_27] = gMonIcon_Filler_27,
    [SPECIES_FILLER_28] = gMonIcon_Filler_28,
    [SPECIES_FILLER_29] = gMonIcon_Filler_29,
    [SPECIES_FILLER_30] = gMonIcon_Filler_30,
    [SPECIES_FILLER_31] = gMonIcon_Filler_31,
    [SPECIES_FILLER_32] = gMonIcon_Filler_32,
    [SPECIES_FILLER_33] = gMonIcon_Filler_33,
    [SPECIES_FILLER_34] = gMonIcon_Filler_34,
    [SPECIES_FILLER_35] = gMonIcon_Filler_35,
    [SPECIES_FILLER_36] = gMonIcon_Filler_36,
    [SPECIES_ARIADOS_GHOST] = gMonIcon_Ariados_Ghost,
    [SPECIES_FILLER_38] = gMonIcon_Filler_38,
    [SPECIES_CHARIZARD_X] = gMonIcon_Charizard_X,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_PHOKAI] = 6,
    [SPECIES_PHOTASM] = 6,
    [SPECIES_PHOTOGEIST] = 6,
    [SPECIES_TOGEKISS] = 8,
    [SPECIES_OTDORBLE] = 7,
    [SPECIES_LUTRADOR] = 7,
    [SPECIES_DUMBELLION] = 7,
    [SPECIES_BARBELLION] = 7,
    [SPECIES_OCTIRE] = 3,
    [SPECIES_INVERTEBRAKE] = 7,
    [SPECIES_HAAGLET] = 8,
    [SPECIES_WARTHAAG] = 4,
    [SPECIES_TAQUITTLE] = 4,
    [SPECIES_ESCARATACO] = 4,
    [SPECIES_CHAD_BUG_1] = 4,
    [SPECIES_CHAD_BUG_2] = 4,
    [SPECIES_PILOPOO] = 4,
    [SPECIES_BILLFALO] = 6,
    [SPECIES_SABLIZZARD] = 7,
    [SPECIES_PASSIMIAN] = 7,
    [SPECIES_CACTAR] = 7,
    [SPECIES_CRACTHORN] = 7,
    [SPECIES_CRACKTUSS] = 7,
    ...
    [SPECIES_ABYSSALDRAGONTHIRDEVO] = 0,
    [SPECIES_ABYSSALDRAGONSECONDEVO] = 0,
    [SPECIES_ABYSSALDRAGONFIRSTEVO] = 0,
    [SPECIES_CHEETO] = 0,
    [SPECIES_FILLER_17] = 0,
    [SPECIES_FILLER_18] = 0,
    [SPECIES_FILLER_19] = 0,
    ...
    [SPECIES_FILLER_35] = 0,
    [SPECIES_FILLER_36] = 0,
    [SPECIES_ARIADOS_GHOST] = 0,
    [SPECIES_FILLER_38] = 0,
    [SPECIES_CHARIZARD_X] = 0,
    [SPECIES_WARKLOCK] = 0,
    [SPECIES_CLOCLOCK] = 0,
    [SPECIES_SPIRETT] = 0,
