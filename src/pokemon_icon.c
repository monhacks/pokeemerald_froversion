...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ROCK_CACTUS_STAGE_1] = gMonIcon_Rock_Cactus_Stage_1,
    [SPECIES_ROCK_CACTUS_STAGE_2] = gMonIcon_Rock_Cactus_Stage_2,
    [SPECIES_CRACKTUSS] = gMonIcon_Cracktuss,
    [SPECIES_DRACASTER] = gMonIcon_Dracaster,
    [SPECIES_BLUE EYES] = gMonIcon_Blue Eyes,
    [SPECIES_FILLER_1] = gMonIcon_Filler_1,
    [SPECIES_FILLER_2] = gMonIcon_Filler_2,
    [SPECIES_FILLER_3] = gMonIcon_Filler_3,
    [SPECIES_FILLER_4] = gMonIcon_Filler_4,
    [SPECIES_FILLER_5] = gMonIcon_Filler_5,
    [SPECIES_FILLER_6] = gMonIcon_Filler_6,
    [SPECIES_FILLER_7] = gMonIcon_Filler_7,
    [SPECIES_FILLER_8] = gMonIcon_Filler_8,
    [SPECIES_FILLER_9] = gMonIcon_Filler_9,
    [SPECIES_FILLER_10] = gMonIcon_Filler_10,
    [SPECIES_FILLER_11] = gMonIcon_Filler_11,
    [SPECIES_FILLER_12] = gMonIcon_Filler_12,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_PHOKAI] = 2,
    [SPECIES_PHOTASM] = 2,
    [SPECIES_PHOTOGEIST] = 2,
    [SPECIES_TOGEKISS] = 2,
    [SPECIES_OTDORBLE] = 2,
    [SPECIES_LUTRADOR] = 2,
    [SPECIES_DUMBELLION] = 2,
    [SPECIES_BARBELLION] = 2,
    [SPECIES_OCTIRE] = 2,
    [SPECIES_INVERTEBRAKE] = 2,
    [SPECIES_HAAGLET] = 2,
    [SPECIES_WARTHAAG] = 2,
    [SPECIES_TAQUITTLE] = 2,
    [SPECIES_ESCARATACO] = 2,
    [SPECIES_CHAD_BUG_1] = 2,
    [SPECIES_CHAD_BUG_2] = 2,
    [SPECIES_PILOPOO] = 2,
    [SPECIES_BILLFALO] = 2,
    [SPECIES_SABLIZZARD] = 2,
    [SPECIES_PASSIMIAN] = 2,
    [SPECIES_ROCK_CACTUS_STAGE_1] = 2,
    [SPECIES_ROCK_CACTUS_STAGE_2] = 2,
    [SPECIES_CRACKTUSS] = 2,
    [SPECIES_DRACASTER] = 2,
    [SPECIES_BLUE EYES] = 2,
    [SPECIES_FILLER_1] = 2,
