...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_BUCCANILE] = gMonIcon_Buccanile,
    [SPECIES_BUCCANITE] = gMonIcon_Buccanite,
    [SPECIES_BUCCAFEAR] = gMonIcon_Buccafear,
    [SPECIES_KOPIRAR] = gMonIcon_Kopirar,
    [SPECIES_KOPISPAR] = gMonIcon_Kopispar,
    [SPECIES_KOPIROAR] = gMonIcon_Kopiroar,
    [SPECIES_WALLITE] = gMonIcon_Wallite,
    [SPECIES_WALLOCK] = gMonIcon_Wallock,
    [SPECIES_WARSOCK] = gMonIcon_Warsock,
    [SPECIES_KICWINDO] = gMonIcon_Kicwindo,
    [SPECIES_HAUSODOOM] = gMonIcon_Hausodoom,
    [SPECIES_DROPYCE] = gMonIcon_Dropyce,
    [SPECIES_METAROURA] = gMonIcon_Metaroura,
    [SPECIES_CHERNABOG] = gMonIcon_Chernabog,
    [SPECIES_CARLILE] = gMonIcon_Carlile,
