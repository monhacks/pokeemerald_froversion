...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_Landmine, 0x0080, ANIM_TAG_LANDMINE},
};
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_Landmine, ANIM_TAG_LANDMINE},
};
...
void DoMoveAnim(u16 move)
{
    ...
    if (GetBattleMoveTargetFlags(move, gBattleMons[gBattlerAttacker].ability) & MOVE_TARGET_FOES_AND_ALLY && IsDoubleBattle(gBattleAnimTarget))
    {
