...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, TRAINER_GENTLEMAN_2_TRAINERS_HALL_3_BADGES, TRAINER_GENTLEMAN_2_TRAINERS_HALL_4_BADGES, TRAINER_GENTLEMAN_2_TRAINERS_HALL_5_BADGES, TRAINER_GENTLEMAN_2_TRAINERS_HALL_6_BADGES, ROUTE121),
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE_1, TRAINER_GENTLEMAN_2_TRAINERS_HALL_7_BADGES, TRAINER_GENTLEMAN_2_TRAINERS_HALL_8_BADGES, TRAINER_GENTLEMAN_2_TRAINERS_HALL_CHAMPION, TRAINER_GENTLEMAN_TRAINERS_HALL_CHAMPION, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_GENTLEMAN_TRAINERS_HALL_8_BADGES, TRAINER_GENTLEMAN_TRAINERS_HALL_7_BADGES, TRAINER_GENTLEMAN_TRAINERS_HALL_6_BADGES, TRAINER_GENTLEMAN_TRAINERS_HALL_5_BADGES, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_GENTLEMAN_TRAINERS_HALL_4_BADGES, TRAINER_GENTLEMAN_TRAINERS_HALL_3_BADGES, TRAINER_LASS_TRAINERS_HALL_CHAMPION, TRAINER_LASS_TRAINERS_HALL_8_BADGES, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY_1, TRAINER_LASS_TRAINERS_HALL_7_BADGES, TRAINER_LASS_TRAINERS_HALL_6_BADGES, TRAINER_LASS_TRAINERS_HALL_5_BADGES, TRAINER_LASS_TRAINERS_HALL_4_BADGES, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_LASS_TRAINERS_HALL_3_BADGES, TRAINER_RICH_BOY_TRAINERS_HALL_CHAMPION, TRAINER_RICH_BOY_TRAINERS_HALL_8_BADGES, TRAINER_RICH_BOY_TRAINERS_HALL_7_BADGES, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, TRAINER_RICH_BOY_TRAINERS_HALL_6_BADGES, TRAINER_RICH_BOY_TRAINERS_HALL_5_BADGES, TRAINER_RICH_BOY_TRAINERS_HALL_4_BADGES, TRAINER_RICH_BOY_TRAINERS_HALL_3_BADGES, ROUTE121),
    ...
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, TRAINER_MATT_FINAL_BOSS, TRAINER_MAGEEVERSION_FRO_SNOWFLAKE_CHALLENGER, TRAINER_STEVE_4, TRAINER_STEVE_5, ROUTE114),
    ...
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_SIDNEY_REMATCH, TRAINER_PHOBE_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_DRAKE_REMATCH, ROUTE127),
    ...
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON_1, TRAINER_DRAKE_REMATCH_2, TRAINER_DRAKE_REMATCH_3, TRAINER_DRAKE_REMATCH_4, TRAINER_DALTON_5, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, TRAINER_SIDNEY_REMATCH_2, TRAINER_SIDNEY_REMATCH_3, TRAINER_SIDNEY_REMATCH_4, TRAINER_BERNIE_5, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, TRAINER_PHOBE_REMATCH_2, TRAINER_PHOBE_REMATCH_3, TRAINER_PHOBE_REMATCH_4, TRAINER_ETHAN_5, JAGGED_PASS),
    ...
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY_1, TRAINER_GLACIA_REMATCH_2, TRAINER_GLACIA_REMATCH_3, TRAINER_GLACIA_REMATCH_4, TRAINER_JEFFREY_5, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON_1, TRAINER_ISIAH_NALLS, TRAINER_CAMERON_3, TRAINER_CAMERON_4, TRAINER_CAMERON_5, ROUTE123),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_MESSENGER_1, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_BARB, TRAINER_FINN, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, RUSTBORO_CITY),
...
void StartMurkrowBattle(void)
{
    u8 transitionId;
    u16 species;
    s32 move1 = MOVE_DRILL_PECK;
    s32 move2 = MOVE_SHADOW_BALL;
    s32 move3 = MOVE_DOUBLE_EDGE;
    s32 move4 = MOVE_SWAGGER;
...
void StartVenusaurBattle(void)
{
    u8 transitionId;
    u16 species;
    s32 move1 = MOVE_SYNTHESIS;
    s32 move2 = MOVE_SLUDGE_BOMB;
    s32 move3 = MOVE_CURSE;
    s32 move4 = MOVE_LEECH_SEED;
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_TEAM_MAGMA
        || gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ANTIFA_LEADER
        || gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_MAGMA_ADMIN)
        return B_TRANSITION_MAGMA;

    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_TEAM_MAGA
        || gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_MAGA_LEADER
