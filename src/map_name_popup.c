...
{
    [MAPSEC_LAKE_MEAD_VILLAGE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_WALMORE_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_NIAGARA_VILLAGE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SUMMIT_CAVERNS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
