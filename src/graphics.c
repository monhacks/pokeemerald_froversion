...
const u32 gBattleAnimSpriteGfx_Landmine[] = INCBIN_U32("graphics/battle_anims/sprites/new/landmine.4bpp.lz");
const u32 gBattleAnimSpritePal_Landmine[] = INCBIN_U32("graphics/battle_anims/sprites/new/landmine.gbapal.lz");
...
const u16 gMonIconPalettes[][16] =
{
    ...
    INCBIN_U16("graphics/pokemon/icon_palettes/icon_palette_6.gbapal"),
    INCBIN_U16("graphics/pokemon/icon_palettes/icon_palette_7.gbapal"),
    INCBIN_U16("graphics/pokemon/icon_palettes/icon_palette_8.gbapal"),
};
