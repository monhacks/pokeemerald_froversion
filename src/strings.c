...
const u8 gText_DefaultNameReid[] = _("Frump");
const u8 gText_DefaultNameJude[] = _("Frozone");
const u8 gText_DefaultNameJaxson[] = _("Froton");
const u8 gText_DefaultNameEaston[] = _("Fro");
const u8 gText_DefaultNameWalker[] = _("Frodo");
const u8 gText_DefaultNameTeru[] = _("Frito");
const u8 gText_DefaultNameJohnny[] = _("Frozilla");
const u8 gText_DefaultNameBrett[] = _("Frump");
const u8 gText_DefaultNameSeth[] = _("Frozone");
const u8 gText_DefaultNameTerry[] = _("Fro");
const u8 gText_DefaultNameCasey[] = _("Frito");
const u8 gText_DefaultNameDarren[] = _("Frozilla");
const u8 gText_DefaultNameLandon[] = _("Frump");
const u8 gText_DefaultNameCollin[] = _("Frozone");
const u8 gText_DefaultNameStanley[] = _("Fro");
