...
const u8 gText_DefaultNameStu[] = _("Finn");
const u8 gText_DefaultNameMilton[] = _("Judge2");
const u8 gText_DefaultNameTom[] = _("Judge3");
const u8 gText_DefaultNameKenny[] = _("Frozilla");
const u8 gText_DefaultNameReid[] = _("Morchel");
...
const u8 gText_MenuOptionSwitchChar[] = _("SWITCH");
