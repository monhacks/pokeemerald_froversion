...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_GENTLEMAN_2, 10},
    {TRAINER_CLASS_GENTLEMAN_3, 12},
    {TRAINER_CLASS_GENTLEMAN_4, 14},
    ...
    {TRAINER_CLASS_LASS_2, 5},
    {TRAINER_CLASS_LASS_3, 6},
    {TRAINER_CLASS_LASS_4, 7},
    {TRAINER_CLASS_LASS_5, 8},
