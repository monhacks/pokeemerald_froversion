...
static const u16 sMysteryGiftFlags[] =
{
    ...
    FLAG_RIVERTON_FUEL_QUEST_STARTED,
    FLAG_RIVERTON_FUEL_QUEST_COMPLETED,
    FLAG_DEFEATED_SHADOW_CHARIZARD,
    FLAG_TURNED_OFF_GENERATOR_1,
    FLAG_TURNED_OFF_GENERATOR_2,
    FLAG_TURNED_OFF_GENERATOR_3,
    FLAG_TURNED_OFF_GENERATOR_4,
    FLAG_TURNED_OFF_GENERATOR_5,
    FLAG_TURNED_OFF_GENERATOR_6,
    FLAG_TURNED_OFF_GENERATOR_7,
    FLAG_TURNED_OFF_GENERATOR_8,
    FLAG_TURNED_OFF_GENERATOR_9,
    FLAG_TURNED_OFF_GENERATOR_10,
    FLAG_TURNED_OFF_GENERATOR_11,
    FLAG_HIDE_MAGA_HIDEOUT_SCIENTISTS,
    FLAG_POST_CHARIZARD_CUTSCENE_TRIGGERED,
