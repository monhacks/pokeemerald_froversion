...
static const u8 sText_DontLeaveBirch[] = _("Prof. Tilyou: Don't leave me like this!\p");
...
static const u8 sText_UnlockedAbility[] = _("{B_BUFF1} unlocked {B_BUFF2}!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_UNLOCKABILITY - 12] = sText_UnlockedAbility,
...
{
    STRINGID_TERRAINBECOMESMISTY, STRINGID_TERRAINBECOMESGRASSY, STRINGID_TERRAINBECOMESELECTRIC, STRINGID_TERRAINBECOMESPSYCHIC, STRINGID_DARKTETHERACTIVATES, STRINGID_DRAGONRAVINEACTIVATES
};
...
const u16 gMissStringIds[] =
{
    ...
    STRINGID_PKMNLEVITATEDGROUNDMOVESMISS
};
