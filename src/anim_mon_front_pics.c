...
const u32 gMonFrontPic_DugtrioShadow[] = INCBIN_U32("graphics/pokemon/dugtrio/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Ariados_Ghost[] = INCBIN_U32("graphics/pokemon/ariados_ghost/anim_front.4bpp.lz");
