...
const u32 gMonFrontPic_Buccanile[] = INCBIN_U32("graphics/pokemon/buccanile/anim_front.4bpp.lz");
const u32 gMonFrontPic_Buccanite[] = INCBIN_U32("graphics/pokemon/buccanite/anim_front.4bpp.lz");
const u32 gMonFrontPic_Buccafear[] = INCBIN_U32("graphics/pokemon/buccafear/anim_front.4bpp.lz");
const u32 gMonFrontPic_Kopirar[] = INCBIN_U32("graphics/pokemon/kopirar/anim_front.4bpp.lz");
const u32 gMonFrontPic_Kopispar[] = INCBIN_U32("graphics/pokemon/kopispar/anim_front.4bpp.lz");
const u32 gMonFrontPic_Kopiroar[] = INCBIN_U32("graphics/pokemon/kopiroar/anim_front.4bpp.lz");
const u32 gMonFrontPic_Wallite[] = INCBIN_U32("graphics/pokemon/wallite/anim_front.4bpp.lz");
const u32 gMonFrontPic_Wallock[] = INCBIN_U32("graphics/pokemon/wallock/anim_front.4bpp.lz");
const u32 gMonFrontPic_Warsock[] = INCBIN_U32("graphics/pokemon/warsock/anim_front.4bpp.lz");
const u32 gMonFrontPic_Kicwindo[] = INCBIN_U32("graphics/pokemon/kicwindo/anim_front.4bpp.lz");
const u32 gMonFrontPic_Hausodoom[] = INCBIN_U32("graphics/pokemon/hausodoom/anim_front.4bpp.lz");
const u32 gMonFrontPic_Dropyce[] = INCBIN_U32("graphics/pokemon/dropyce/anim_front.4bpp.lz");
const u32 gMonFrontPic_Metaroura[] = INCBIN_U32("graphics/pokemon/metaroura/anim_front.4bpp.lz");
const u32 gMonFrontPic_Chernabog[] = INCBIN_U32("graphics/pokemon/chernabog/anim_front.4bpp.lz");
const u32 gMonFrontPic_Carlile[] = INCBIN_U32("graphics/pokemon/carlile/anim_front.4bpp.lz");
