...
{
    {TRAINER_CLASS_TEAM_MAGA, TRAINER_ENCOUNTER_MUSIC_AQUA},
    {TRAINER_CLASS_AQUA_ADMIN, TRAINER_ENCOUNTER_MUSIC_AQUA},
    {TRAINER_CLASS_MAGA_LEADER, TRAINER_ENCOUNTER_MUSIC_AQUA},
    ...
    {TRAINER_CLASS_ANTIFA_LEADER, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_MESSENGER, TRAINER_ENCOUNTER_MUSIC_AQUA},
    {TRAINER_CLASS_BOBBY, TRAINER_ENCOUNTER_MUSIC_MALE},
};
...
static const u16 sPrizeListToxic[]       = {ITEM_TM39_ROCK_TOMB,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM08_BULK_UP,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
