...
static bool8 StartMenuSwitchCharCallback(void);
...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    {gText_SwitchChar, {.u8_void = StartMenuSwitchCharCallback}},
};
...
static void BuildNormalStartMenu(void)
{
    ...
    AddStartMenuAction(MENU_ACTION_SWITCH_CHAR);
...
static bool8 HandleStartMenuInput(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gMenuCallback != StartMenuSaveCallback
            ...
            && gMenuCallback != StartMenuSwitchCharCallback)
        {
...
extern const u8 MAGM8ExtendedForest_Eventscript_GiveUp[];
...
static bool8 StartMenuSwitchCharCallback(void)
{
    ...
    HideStartMenu(); // Hide start menu
    ScriptContext2_Enable();
    ScriptContext1_SetupScript(EventScript_CharacterSwitch);
    return TRUE;
}
